...
export default class DyteSelf extends DyteSelfMedia {
    ...
    get mediaPermissions(): {
        ...
        audio?: "NOT_REQUESTED" | "ACCEPTED" | "DENIED" | "SYSTEM_DENIED" | "COULD_NOT_START";
        video?: "NOT_REQUESTED" | "ACCEPTED" | "DENIED" | "SYSTEM_DENIED" | "COULD_NOT_START";
        screenshare?: "NOT_REQUESTED" | "ACCEPTED" | "DENIED" | "SYSTEM_DENIED" | "COULD_NOT_START";
    };
