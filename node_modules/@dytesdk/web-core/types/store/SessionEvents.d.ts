export declare enum SessionEvents {
    ...
    AUDIO_TRACK_CLOSED = "AUDIO_TRACK_CLOSED",
    AUDIO_TRACK_CHANGED = "AUDIO_TRACK_CHANGED",
    AUDIO_TRACK_CREATED = "AUDIO_TRACK_CREATED",
    VIDEO_TRACK_ANALYSIS = "VIDEO_TRACK_ANALYSIS",
    VIDEO_TRACK_ANALYSIS_ERROR = "VIDEO_TRACK_ANALYSIS_ERROR",
    VIDEO_TRACK_CLOSED = "VIDEO_TRACK_CLOSED",
    VIDEO_TRACK_CHANGED = "VIDEO_TRACK_CHANGED",
    VIDEO_TRACK_CREATED = "VIDEO_TRACK_CREATED",
    SCREENSHARE_AUDIO_TRACK_ANALYSIS = "SCREENSHARE_AUDIO_TRACK_ANALYSIS",
    SCREENSHARE_AUDIO_TRACK_CLOSED = "SCREENSHARE_AUDIO_TRACK_CLOSED",
    SCREENSHARE_AUDIO_TRACK_CREATED = "SCREENSHARE_AUDIO_TRACK_CREATED",
    SCREENSHARE_VIDEO_TRACK_ANALYSIS = "SCREENSHARE_VIDEO_TRACK_ANALYSIS",
    SCREENSHARE_VIDEO_TRACK_ANALYSIS_ERROR = "SCREENSHARE_VIDEO_TRACK_ANALYSIS_ERROR",
    SCREENSHARE_VIDEO_TRACK_CLOSED = "SCREENSHARE_VIDEO_TRACK_CLOSED",
    SCREENSHARE_VIDEO_TRACK_CREATED = "SCREENSHARE_VIDEO_TRACK_CREATED",
    SCREENSHARE_TRACK_CHANGED = "SCREENSHARE_TRACK_CHANGED",
    CANDIDATE_PEER_UPDATE = "CANDIDATE_PEER_UPDATE",
    INBOUND_RTP_UPDATE = "INBOUND_RTP_UPDATE",
    OUTBOUND_RTP_UPDATE = "OUTBOUND_RTP_UPDATE",
    SEND_TRANSPORT_CLOSED = "SEND_TRANSPORT_CLOSED",
    RECV_TRANSPORT_CLOSED = "RECV_TRANSPORT_CLOSED",
    SEND_TRANSPORT_CREATED = "SEND_TRANSPORT_CREATED",
    RECV_TRANSPORT_CREATED = "RECV_TRANSPORT_CREATED",
    ...
    HIVE_ROOM_REJOINING = "hive/room-rejoining",
    HIVE_TRANPSORT_RECONNECTING = "hive/transport-reconnecting",
    ...
    PEER_WITHDRAWN_REQUEST_TO_JOIN_STAGE = "websocket/request-to-join-stage-peer-withdrawn",
