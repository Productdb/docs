import { GenericHandlerResult, HandlerFactory, HandlerInterface, HandlerRunOptions, HandlerSendOptions, HandlerSendResult } from './HandlerInterface';
export declare class Firefox110 extends HandlerInterface {
    private _direction?;
    private _pc;
    ...
    send({ track, encodings, screenShare, }: HandlerSendOptions): Promise<HandlerSendResult>;
