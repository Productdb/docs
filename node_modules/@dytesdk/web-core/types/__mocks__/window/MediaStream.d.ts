declare const MediaStreamMock: {
    getAudioTracks: import("@vitest/spy").Mock<[], import("@vitest/spy").Mock<[], {
        ...
        emit: (event: "ended" | "mute") => Promise<void>;
    }>[]>;
    getVideoTracks: import("@vitest/spy").Mock<[], import("@vitest/spy").Mock<[], {
        kind: import("@vitest/spy").Mock<any[], any>;
        id: import("@vitest/spy").Mock<any[], any>;
        label: import("@vitest/spy").Mock<any[], any>;
        enabled: boolean;
