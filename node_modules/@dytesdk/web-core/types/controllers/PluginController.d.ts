...
export default class PluginController {
    ...
    static init(receivedPlugins: DytePluginResponse[], pluginSocketHandler: PluginSocketHandler, chatSocketHandler: ChatSocketHandler, chat: DyteChat, self: DyteSelf, participants: DyteParticipants, capabilities: SocketServiceCapabilities): Promise<PluginController>;
