...
import { d as canViewPolls } from './sidebar.js';
...
const DytePollsToggle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dytePollsToggleCss; }
}, [1, "dyte-polls-toggle", {
    "variant": [513],
    "meeting": [16],
    "states": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-polls-toggle", "dyte-controlbar-button", "dyte-icon", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-polls-toggle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DytePollsToggle$1);
      }
      break;
...
const DytePollsToggle = DytePollsToggle$1;
const defineCustomElement = defineCustomElement$1;

export { DytePollsToggle, defineCustomElement };
