...
const DyteAudioTile$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteAudioTileCss; }
}, [1, "dyte-audio-tile", {
    "meeting": [16],
    "config": [16],
    "size": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-audio-tile", "dyte-avatar", "dyte-icon", "dyte-name-tag", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-audio-tile":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteAudioTile$1);
      }
      break;
    case "dyte-avatar":
      if (!customElements.get(tagName)) {
...
const DyteAudioTile = DyteAudioTile$1;
const defineCustomElement = defineCustomElement$1;

export { DyteAudioTile, defineCustomElement };
