...
import { g as generateChatGroupKey } from './chat.js';
...
const DyteChatSelectorUi$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteChatSelectorUiCss; }
}, [1, "dyte-chat-selector-ui", {
    "selfUserId": [1, "self-user-id"],
    "selectedGroupId": [1, "selected-group-id"],
    "unreadCounts": [16],
    "groups": [16],
    "iconPack": [16],
    "t": [16],
    "showParticipantsPanel": [32],
    "query": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["dyte-chat-selector-ui", "dyte-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-chat-selector-ui":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteChatSelectorUi$1);
      }
      break;
    case "dyte-icon":
      if (!customElements.get(tagName)) {
...
const DyteChatSelectorUi = DyteChatSelectorUi$1;
const defineCustomElement = defineCustomElement$1;

export { DyteChatSelectorUi, defineCustomElement };
