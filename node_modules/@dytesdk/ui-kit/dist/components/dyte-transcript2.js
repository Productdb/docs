...
const DyteTranscript = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteTranscriptCss; }
}, [1, "dyte-transcript", {
    "transcript": [16],
    "t": [16],
    "timeout": [32]
...
function defineCustomElement() {
  ...
  const components = ["dyte-transcript"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-transcript":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteTranscript);
      }
      break;
  } });
}

export { DyteTranscript as D, defineCustomElement as d };
