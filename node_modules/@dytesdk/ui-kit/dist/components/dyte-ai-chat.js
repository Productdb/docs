...
const DyteAiChat$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteAiChatCss; }
}, [1, "dyte-ai-chat", {
    "t": [16]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["dyte-ai-chat"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-ai-chat":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteAiChat$1);
      }
      break;
  } });
}

const DyteAiChat = DyteAiChat$1;
const defineCustomElement = defineCustomElement$1;

export { DyteAiChat, defineCustomElement };
