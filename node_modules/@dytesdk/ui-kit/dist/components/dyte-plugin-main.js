...
const DytePluginMain$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dytePluginMainCss; }
}, [1, "dyte-plugin-main", {
    "meeting": [16],
    "plugin": [16],
    "iconPack": [16],
  ...
  components.forEach(tagName => { switch (tagName) {
    case "dyte-plugin-main":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DytePluginMain$1);
      }
      break;
    case "dyte-button":
      if (!customElements.get(tagName)) {
...
const DytePluginMain = DytePluginMain$1;
const defineCustomElement = defineCustomElement$1;

export { DytePluginMain, defineCustomElement };
