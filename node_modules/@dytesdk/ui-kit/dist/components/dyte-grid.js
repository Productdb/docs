...
import { d as defineCustomElement$5 } from './dyte-livestream-indicator2.js';
import { d as defineCustomElement$4 } from './dyte-livestream-player2.js';
import { d as defineCustomElement$3 } from './dyte-spinner2.js';
import { d as defineCustomElement$2 } from './dyte-viewer-count2.js';
...
const DyteGrid$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteGridCss; }
}, [1, "dyte-grid", {
    "layout": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-grid", "dyte-button", "dyte-icon", "dyte-livestream-indicator", "dyte-livestream-player", "dyte-spinner", "dyte-viewer-count"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-grid":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteGrid$1);
      }
      break;
    case "dyte-button":
      if (!customElements.get(tagName)) {
...
const DyteGrid = DyteGrid$1;
const defineCustomElement = defineCustomElement$1;

export { DyteGrid, defineCustomElement };
