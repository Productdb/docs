import { proxyCustomElement, HTMLElement, writeTask, h } from '@stencil/core/internal/client';
import './store.js';
...
const DyteMessageListView$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.sizes = new Map();
  ...
  static get style() { return dyteMessageListViewCss; }
}, [0, "dyte-message-list-view", {
    "messages": [16],
    "renderer": [16],
    "loadMore": [16],
    "visibleItemsCount": [2, "visible-items-count"],
    "estimateItemSize": [2, "estimate-item-size"],
    "iconPack": [16],
    "range": [32],
    "isFetching": [32],
    "autoScroll": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-message-list-view", "dyte-icon", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-message-list-view":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteMessageListView$1);
      }
      break;
    case "dyte-icon":
      if (!customElements.get(tagName)) {
...
const DyteMessageListView = DyteMessageListView$1;
const defineCustomElement = defineCustomElement$1;

export { DyteMessageListView, defineCustomElement };
