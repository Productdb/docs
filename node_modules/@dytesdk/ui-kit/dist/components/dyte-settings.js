...
import { d as defineCustomElement$8 } from './dyte-audio-visualizer2.js';
import { d as defineCustomElement$7 } from './dyte-button2.js';
import { d as defineCustomElement$6 } from './dyte-icon2.js';
import { d as defineCustomElement$5 } from './dyte-participant-tile2.js';
import { d as defineCustomElement$4 } from './dyte-settings-audio2.js';
import { d as defineCustomElement$3 } from './dyte-settings-video2.js';
import { d as defineCustomElement$2 } from './dyte-switch2.js';
...
const DyteSettings$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteSettingsCss; }
}, [1, "dyte-settings", {
    "meeting": [16],
    "states": [16],
    "size": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-settings", "dyte-audio-visualizer", "dyte-button", "dyte-icon", "dyte-participant-tile", "dyte-settings-audio", "dyte-settings-video", "dyte-switch"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-settings":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteSettings$1);
      }
      break;
...
const DyteSettings = DyteSettings$1;
const defineCustomElement = defineCustomElement$1;

export { DyteSettings, defineCustomElement };
