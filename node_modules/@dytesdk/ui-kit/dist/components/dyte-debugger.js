...
import { d as defineCustomElement$8 } from './dyte-debugger-audio2.js';
import { d as defineCustomElement$7 } from './dyte-debugger-issues-ui2.js';
import { d as defineCustomElement$6 } from './dyte-debugger-permissions-ui2.js';
import { d as defineCustomElement$5 } from './dyte-debugger-screenshare2.js';
import { d as defineCustomElement$4 } from './dyte-debugger-video2.js';
import { d as defineCustomElement$3 } from './dyte-icon2.js';
import { d as defineCustomElement$2 } from './dyte-information-tooltip2.js';
...
const DyteDebugger$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteDebuggerCss; }
}, [1, "dyte-debugger", {
    "meeting": [16],
    "states": [16],
    "size": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-debugger", "dyte-button", "dyte-debugger-audio", "dyte-debugger-issues-ui", "dyte-debugger-permissions-ui", "dyte-debugger-screenshare", "dyte-debugger-video", "dyte-icon", "dyte-information-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-debugger":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteDebugger$1);
      }
      break;
    case "dyte-button":
      if (!customElements.get(tagName)) {
...
const DyteDebugger = DyteDebugger$1;
const defineCustomElement = defineCustomElement$1;

export { DyteDebugger, defineCustomElement };
