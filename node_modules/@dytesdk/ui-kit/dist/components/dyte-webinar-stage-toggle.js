...
const DyteWebinarStageToggle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteWebinarStageToggleCss; }
}, [1, "dyte-webinar-stage-toggle", {
    "variant": [513],
    "meeting": [16],
    "size": [513],
    "iconPack": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-webinar-stage-toggle", "dyte-controlbar-button", "dyte-icon", "dyte-spinner", "dyte-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-webinar-stage-toggle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteWebinarStageToggle$1);
      }
      break;
...
const DyteWebinarStageToggle = DyteWebinarStageToggle$1;
const defineCustomElement = defineCustomElement$1;

export { DyteWebinarStageToggle, defineCustomElement };
