...
const DyteChannelSelectorUi$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteChannelSelectorUiCss; }
}, [1, "dyte-channel-selector-ui", {
    "channels": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-channel-selector-ui", "dyte-avatar", "dyte-button", "dyte-icon", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-channel-selector-ui":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteChannelSelectorUi$1);
      }
      break;
    case "dyte-avatar":
      if (!customElements.get(tagName)) {
...
const DyteChannelSelectorUi = DyteChannelSelectorUi$1;
const defineCustomElement = defineCustomElement$1;

export { DyteChannelSelectorUi, defineCustomElement };
