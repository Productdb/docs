import { proxyCustomElement, HTMLElement, createEvent, writeTask, forceUpdate, h, Host } from '@stencil/core/internal/client';
...
const DyteChannelCreator$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get $el() { return this; }
  static get style() { return dyteChannelCreatorCss; }
}, [1, "dyte-channel-creator", {
    "meeting": [16],
    "t": [16],
    "iconPack": [16],
    "channelName": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-channel-creator", "dyte-avatar", "dyte-button", "dyte-icon", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-channel-creator":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteChannelCreator$1);
      }
      break;
    case "dyte-avatar":
      if (!customElements.get(tagName)) {
...
const DyteChannelCreator = DyteChannelCreator$1;
const defineCustomElement = defineCustomElement$1;

export { DyteChannelCreator, defineCustomElement };
