...
const DyteScreenshareView$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    ...
    this.onRemoteUpdate = ({ payload, type }) => {
      ...
      if (type === RemoteUpdateType.REQUEST_RECEIVED && !Boolean((_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.remote) === null || _b === void 0 ? void 0 : _b.active)) {
        ...
        state.activeRemoteAccessManager = true;
      }
  ...
  static get style() { return dyteScreenshareViewCss; }
}, [1, "dyte-screenshare-view", {
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-screenshare-view", "dyte-button", "dyte-icon", "dyte-menu", "dyte-menu-item", "dyte-menu-list", "dyte-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-screenshare-view":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteScreenshareView$1);
      }
      break;
    case "dyte-button":
      if (!customElements.get(tagName)) {
...
const DyteScreenshareView = DyteScreenshareView$1;
const defineCustomElement = defineCustomElement$1;

export { DyteScreenshareView, defineCustomElement };
