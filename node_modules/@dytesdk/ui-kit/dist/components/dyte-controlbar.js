...
const DyteControlbar$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteControlbarCss; }
}, [1, "dyte-controlbar", {
    "variant": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-controlbar"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-controlbar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteControlbar$1);
      }
      break;
  } });
}

const DyteControlbar = DyteControlbar$1;
const defineCustomElement = defineCustomElement$1;

export { DyteControlbar, defineCustomElement };
