...
const DyteSpotlightIndicator = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteSpotlightIndicatorCss; }
...
function defineCustomElement() {
  ...
  const components = ["dyte-spotlight-indicator", "dyte-icon", "dyte-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-spotlight-indicator":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteSpotlightIndicator);
      }
      break;
    case "dyte-icon":
      if (!customElements.get(tagName)) {
...
export { DyteSpotlightIndicator as D, defineCustomElement as d };
