...
const DyteRecordingIndicator$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteRecordingIndicatorCss; }
}, [1, "dyte-recording-indicator", {
    "meeting": [16],
    "size": [513],
    "t": [16],
    "iconPack": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-recording-indicator", "dyte-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-recording-indicator":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteRecordingIndicator$1);
      }
      break;
    case "dyte-icon":
      if (!customElements.get(tagName)) {
...
const DyteRecordingIndicator = DyteRecordingIndicator$1;
const defineCustomElement = defineCustomElement$1;

export { DyteRecordingIndicator, defineCustomElement };
