...
import { r as resetRoomCount, p as participantIdentifier } from './breakout-rooms.js';
import { B as BreakoutRoomsManager } from './breakout-rooms-manager.js';
import { d as defineCustomElement$9 } from './dyte-avatar2.js';
import { d as defineCustomElement$8 } from './dyte-breakout-room-manager2.js';
import { d as defineCustomElement$7 } from './dyte-breakout-room-participants2.js';
import { d as defineCustomElement$6 } from './dyte-button2.js';
import { d as defineCustomElement$5 } from './dyte-counter2.js';
...
const MIN_ROOMS = 1;
const DyteBreakoutRoomsManager$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteBreakoutRoomsManagerCss; }
}, [1, "dyte-breakout-rooms-manager", {
    "meeting": [16],
    "states": [16],
    "iconPack": [16],
    "t": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-breakout-rooms-manager", "dyte-avatar", "dyte-breakout-room-manager", "dyte-breakout-room-participants", "dyte-button", "dyte-counter", "dyte-icon", "dyte-spinner", "dyte-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-breakout-rooms-manager":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteBreakoutRoomsManager$1);
      }
      break;
    case "dyte-avatar":
      if (!customElements.get(tagName)) {
...
const DyteBreakoutRoomsManager = DyteBreakoutRoomsManager$1;
const defineCustomElement = defineCustomElement$1;

export { DyteBreakoutRoomsManager, defineCustomElement };
