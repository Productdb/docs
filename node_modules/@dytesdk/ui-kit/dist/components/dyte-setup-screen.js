...
import { s as shorten } from './string.js';
...
const DyteSetupScreen$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteSetupScreenCss; }
}, [1, "dyte-setup-screen", {
    "meeting": [16],
    "states": [16],
    "size": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-setup-screen", "dyte-button", "dyte-icon", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-setup-screen":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteSetupScreen$1);
      }
      break;
    case "dyte-button":
      if (!customElements.get(tagName)) {
...
const DyteSetupScreen = DyteSetupScreen$1;
const defineCustomElement = defineCustomElement$1;

export { DyteSetupScreen, defineCustomElement };
