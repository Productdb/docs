...
const DyteAiHome$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteAiHomeCss; }
}, [1, "dyte-ai-home", {
    "meeting": [16],
    "initialMessages": [16],
    "prompt": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["dyte-ai-home", "dyte-icon", "dyte-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-ai-home":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteAiHome$1);
      }
      break;
    case "dyte-icon":
      if (!customElements.get(tagName)) {
...
const DyteAiHome = DyteAiHome$1;
const defineCustomElement = defineCustomElement$1;

export { DyteAiHome, defineCustomElement };
