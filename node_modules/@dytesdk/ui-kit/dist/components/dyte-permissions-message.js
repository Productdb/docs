...
const DytePermissionsMessage$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dytePermissionsMessageCss; }
  ...
  components.forEach(tagName => { switch (tagName) {
    case "dyte-permissions-message":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DytePermissionsMessage$1);
      }
      break;
    case "dyte-button":
      if (!customElements.get(tagName)) {
...
const DytePermissionsMessage = DytePermissionsMessage$1;
const defineCustomElement = defineCustomElement$1;

export { DytePermissionsMessage, defineCustomElement };
