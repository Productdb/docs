...
import { f as formatName, g as getInitials } from './string.js';
...
const DyteAvatar = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteAvatarCss; }
}, [1, "dyte-avatar", {
    "participant": [16],
    "variant": [513],
    "size": [513],
