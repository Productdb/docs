...
import { r as reverse, h as handleFilesDataTransfer, f as replyBlockPattern, j as extractReplyBlock, s as stripOutReplyBlock, M as MAX_TEXT_LENGTH } from './chat.js';
...
import { d as defineCustomElement$5 } from './dyte-emoji-picker2.js';
...
const MENTION_CHAR = '@';
const DyteChatComposerUi$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteChatComposerUiCss; }
