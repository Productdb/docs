...
const DyteAudioVisualizer = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dyteAudioVisualizerCss; }
}, [1, "dyte-audio-visualizer", {
    "variant": [513],
    "participant": [16],
    "size": [513],
    "iconPack": [16],
...
function defineCustomElement() {
  ...
  const components = ["dyte-audio-visualizer", "dyte-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "dyte-audio-visualizer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DyteAudioVisualizer);
      }
      break;
    case "dyte-icon":
      if (!customElements.get(tagName)) {
...
export { DyteAudioVisualizer as D, defineCustomElement as d };
