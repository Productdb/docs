...
const DyteControlbarButton = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("button", { "aria-label": this.label, part: "button" }, this.isLoading ? (index.h("dyte-spinner", { id: "icon", part: "spinner", iconPack: this.iconPack, t: this.t })) : (index.h("dyte-icon", { id: "icon", icon: this.icon, tabIndex: -1, "aria-hidden": true, part: "icon", iconPack: this.iconPack, t: this.t })), index.h("span", { class: "label", part: "label" }, this.label), this.showWarning && (index.h("dyte-icon", { id: "warning-indicator", icon: this.iconPack.warning, part: "warning-indicator", iconPack: this.iconPack, t: this.t })))));
  }
};
DyteControlbarButton.style = dyteControlbarButtonCss;

exports.dyte_controlbar_button = DyteControlbarButton;
