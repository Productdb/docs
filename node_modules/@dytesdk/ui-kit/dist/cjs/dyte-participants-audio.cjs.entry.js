...
const logger = require('./logger-8a621331.js');
  ...
  async play() {
    ...
    await ((_a = this.audio.play()) === null || _a === void 0 ? void 0 : _a.catch((err) => {
      if (err.name === 'NotAllowedError') {
        ...
        logger.logger.error('[dyte-audio] play() error\n', err);
      }
    }));
  }
  async setDevice(id) {
    var _a, _b, _c;
    if (flags.disableSettingSinkId(this.meeting))
      return;
    await ((_c = (_b = (_a = this.audio).setSinkId) === null || _b === void 0 ? void 0 : _b.call(_a, id)) === null || _c === void 0 ? void 0 : _c.catch((err) => {
      logger.logger.error('[dyte-audio] setSinkId() error\n', err);
    }));
  }
  onError(onError) {
...
const DyteParticipantsAudio = class {
  ...
  async meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    this.setupAudio();
    if (livestream.isLiveStreamViewer(meeting)) {
  ...
  render() {
    return (index.h(index.Host, null, this.showPlayDialog && (index.h("dyte-dialog", { open: true, onDyteDialogClose: this.onDyteDialogClose, hideCloseButton: true, disableEscapeKey: true, iconPack: this.iconPack, t: this.t }, index.h("div", { class: "modal" }, index.h("h3", null, this.t('audio_playback.title')), index.h("p", null, this.t('audio_playback.description')), index.h("dyte-button", { kind: "wide", onClick: () => {
        this.audio.play();
        this.onDyteDialogClose();
...
exports.dyte_participants_audio = DyteParticipantsAudio;
