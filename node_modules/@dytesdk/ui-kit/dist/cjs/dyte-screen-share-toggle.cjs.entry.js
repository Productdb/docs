...
const DyteScreenShareToggle = class {
  ...
  connectedCallback() {
    if (!deviceCanScreenShare()) {
      logger.logger.error('[dyte-screenshare-toggle] Device does not support screensharing.');
      return;
    }
