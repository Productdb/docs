...
const DyteTranscript = class {
  constructor(hostRef) {
    ...
    this.dismiss = index.createEvent(this, "dyteTranscriptDismiss", 7);
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "ctr" }, index.h("p", { class: "message" }, index.h("span", { class: "name" }, this.transcript.name), ": ", this.transcript.transcript))));
  }
