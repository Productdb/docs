...
const DyteDebuggerAudio$2 = class {
  constructor(hostRef) {
    ...
    this.testProgress = index.createEvent(this, "testProgress", 7);
    this.lowVolCount = 0;
    this.silenceCount = 0;
  ...
  getAudioLevelStatus() {
    ...
    return (index.h("div", { class: `row status-text ${style}` }, index.h("dyte-icon", { size: "sm", icon: this.iconPack[icon] }), this.t(message)));
  }
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("audio", { preload: "auto", src: "https://assets.dyte.io/ui-kit/speaker-test.mp3", ref: (el) => (this.testAudioEl = el) }), index.h("div", { id: "header" }, ['Report', 'Troubleshoot'].map((section) => (index.h("dyte-button", { key: section, variant: "ghost", class: { active: this.activeTab === section }, onClick: () => this.setActiveTab(section), iconPack: this.iconPack, t: this.t }, this.t(section))))), this.activeTab === 'Troubleshoot' && (index.h("div", { class: "tab-body" }, index.h("div", null, index.h("div", { class: "stage-indicator" }, "Step ", this.stage + 1, "/3"), this.stage === 0 && (index.h("dyte-debugger-permissions-ui", Object.assign({}, defaults, { mediaType: "audio" }))), this.stage === 1 && (index.h("div", null, index.h("div", { class: "title" }, "Microphone Test"), index.h("div", { class: "text" }, this.t('Please start the microphone test and start speaking in order to test your audio device.')), index.h("dyte-button", { size: "md", onClick: () => this.toggleMicTest() }, this.micPreview ? 'Stop' : 'Start', " Microphone Test"), this.micPreview && (index.h("div", { class: "col" }, index.h("div", { class: "sub-title" }, "Device Information", index.h("dyte-information-tooltip", { iconPack: this.iconPack }, index.h("div", { slot: "tootlip-text", class: "tooltip-text" }, Object.keys(this.micMetadata).map((key) => (index.h("div", null, this.formatLabel(key), ": ", index.h("span", null, this.micMetadata[key]))))))), deviceInfoKeys.map((key) => {
      const val = this.micMetadata[key];
      if (!val)
        return;
      return (index.h("div", { class: "row" }, index.h("div", { class: "label" }, index.h("span", null, this.t(this.formatLabel(key))), ":"), index.h("div", { class: "text" }, this.t(val))));
    }), this.getDeviceInformationStatus(), index.h("div", { class: "sub-title" }, "Audio Level Analysis", index.h("dyte-information-tooltip", { iconPack: this.iconPack }, index.h("div", { slot: "tootlip-text", class: "tooltip-text" }, index.h("div", null, "Volume Level:", index.h("span", null, this.audioTrackStats.volume, "/100")), index.h("div", null, "Low Volume:", index.h("span", null, this.boolToStr(this.audioTrackStats.lowVolume))), index.h("div", null, "Silence Detected:", index.h("span", null, this.boolToStr(this.audioTrackStats.silence))), index.h("div", null, "Noise Detected:", index.h("span", null, this.boolToStr(this.audioTrackStats.clip))), index.h("div", null, "Time:", index.h("span", null, new Date(this.audioTrackStats.timestamp).toLocaleTimeString()))))), index.h("div", { class: "row" }, index.h("dyte-icon", { icon: this.iconPack.speaker, size: "md" }), index.h("div", { class: "volume-indicator" }, index.h("div", { class: "volume-level", ref: (el) => (this.volumeEl = el) }))), this.getAudioLevelStatus())))), this.stage === 2 && (index.h("div", { class: "col" }, index.h("div", { class: "title" }, "Speaker Test"), index.h("div", { class: "text" }, this.t('Upon starting this test, an audio will be played. Please ensure your system volume is not set to zero.')), index.h("dyte-button", { onClick: () => this.toggleSpeakerTest(), size: "md" }, this.speakerPreview ? 'Stop' : 'Start', " Speaker Test"), this.speakerDevice && (index.h("div", null, index.h("div", { class: "sub-title" }, "Device Information"), index.h("div", { class: "row" }, index.h("div", { class: "label" }, index.h("span", null, "Label"), ":"), index.h("div", { class: "text" }, this.speakerDevice.label)))), this.speakerPreview && (index.h("div", null, index.h("p", { class: "sub-title" }, "Are you able to hear the audio?"), index.h("div", { class: "speaker-test" }, index.h("dyte-button", { onClick: () => this.setSpeakerTestResult('success'), size: "sm", variant: "primary" }, "Yes"), index.h("dyte-button", { onClick: () => this.setSpeakerTestResult('failed'), size: "sm", variant: "secondary" }, "No")))), !this.speakerPreview && this.speakerTest !== 'none' && (index.h("div", { class: `row status-text ${this.speakerTest}` }, index.h("dyte-icon", { size: "sm", icon: this.iconPack[this.speakerTest === 'failed' ? 'dismiss' : 'checkmark'] }), this.getSpeakerTestStatus()))))), index.h("div", { class: "stage-manager" }, this.stage < 2 && (index.h("div", { class: { 'stage-button': true, disabled: this.mediaPermission !== 'ACCEPTED' }, onClick: () => this.changeStage(this.stage + 1) }, "Next", index.h("dyte-icon", { size: "sm", icon: this.iconPack.chevron_right }))), this.stage > 0 && (index.h("div", { class: { 'stage-button': true, disabled: this.mediaPermission !== 'ACCEPTED' }, onClick: () => this.changeStage(this.stage - 1) }, index.h("dyte-icon", { size: "sm", icon: this.iconPack.chevron_left }), "Prev"))))), this.activeTab === 'Report' && (index.h("div", { class: "tab-body" }, index.h("dyte-debugger-issues-ui", Object.assign({}, defaults, { mediaType: "audio" }))))));
  }
...
const DyteDebuggerAudio$1 = class {
  ...
  getAudioAnalysisStatus() {
    ...
    if (!((_a = this.audioTrackMetadata) === null || _a === void 0 ? void 0 : _a.label))
      return (index.h("div", { class: `row status-text warning` }, index.h("dyte-icon", { size: "sm", icon: this.iconPack.warning }), this.t('Not Available')));
    if (this.detectLowVolume()) {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { id: "header" }, ['Report', 'Troubleshoot'].map((section) => (index.h("dyte-button", { key: section, variant: "ghost", class: { active: this.activeTab === section }, onClick: () => this.setActiveTab(section), iconPack: this.iconPack, t: this.t }, this.t(section))))), this.activeTab === 'Troubleshoot' && (index.h("div", { class: "tab-body" }, index.h("div", null, index.h("div", { class: "stage-indicator" }, "Step ", this.stage + 1, "/2"), this.stage === 0 && (index.h("dyte-debugger-permissions-ui", Object.assign({}, defaults, { mediaType: "screenshare" }))), this.stage === 1 &&
      (this.screenshareEnabled ? (index.h("div", { class: "col" }, index.h("div", { class: "text" }, "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots."), index.h("dyte-button", { onClick: () => this.toggleScreenshareTest() }, this.screenshareTest ? 'Stop' : 'Start', " Screenshare Tests"), this.screenshareTest && (index.h("div", null, index.h("div", { class: "sub-title" }, "Device Information", index.h("dyte-information-tooltip", null, index.h("div", { slot: "tootlip-text", class: "tooltip-text" }, Object.keys(this.audioTrackMetadata).map((key) => {
        if (key === 'label')
          return;
        return (index.h("div", null, "Audio ", this.formatLabel(key), ":", ' ', index.h("span", null, this.audioTrackMetadata[key])));
      }), Object.keys(this.videoTrackMetadata).map((key) => {
        if (key === 'label')
          return;
        return (index.h("div", null, "Video ", this.formatLabel(key), ":", ' ', index.h("span", null, JSON.stringify(this.videoTrackMetadata[key]))));
      })))), index.h("div", { class: "row align-start" }, index.h("div", { class: "label" }, index.h("span", null, "Audio Label"), ":"), index.h("div", { class: "text" }, this.nullToStr((_a = this.audioTrackMetadata) === null || _a === void 0 ? void 0 : _a.label))), index.h("div", { class: "row align-start" }, index.h("div", { class: "label" }, index.h("span", null, "Video Label"), ":"), index.h("div", { class: "text" }, this.nullToStr((_b = this.videoTrackMetadata) === null || _b === void 0 ? void 0 : _b.label))), this.getDeviceInformationStatus(), index.h("div", { class: "sub-title" }, "Device Analysis"), index.h("div", { class: "row " }, index.h("div", { class: "label" }, index.h("span", null, "Audio Analysis"), " :"), this.getAudioAnalysisStatus()), index.h("div", { class: "row" }, index.h("div", { class: "label" }, index.h("span", null, "Video Analysis"), " :"), this.getVideoAnalysisStatus()))))) : (index.h("div", { class: "col" }, index.h("div", { class: "info" }, index.h("dyte-icon", { size: "sm", icon: this.iconPack.warning }), "You are not sharing your screen."), index.h("div", { class: "text" }, "In order for us to test your screenshare, you need to be sharing your screen. You can enable screenshare from the control bar."))))), index.h("div", { class: "stage-manager" }, this.stage < 1 && (index.h("div", { class: { 'stage-button': true, disabled: this.mediaPermission !== 'ACCEPTED' }, onClick: () => this.changeStage(this.stage + 1) }, "Next", index.h("dyte-icon", { size: "sm", icon: this.iconPack.chevron_right }))), this.stage > 0 && (index.h("div", { class: { 'stage-button': true, disabled: this.mediaPermission !== 'ACCEPTED' }, onClick: () => this.changeStage(this.stage - 1) }, index.h("dyte-icon", { size: "sm", icon: this.iconPack.chevron_left }), "Prev"))))), this.activeTab === 'Report' && (index.h("div", { class: "tab-body" }, index.h("dyte-debugger-issues-ui", Object.assign({}, defaults, { mediaType: "screenshare" }))))));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
...
const DyteDebuggerAudio = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { id: "header" }, ['Report', 'Troubleshoot'].map((section) => (index.h("dyte-button", { key: section, variant: "ghost", class: { active: this.activeTab === section }, onClick: () => this.setActiveTab(section), iconPack: this.iconPack, t: this.t }, this.t(section))))), this.activeTab === 'Troubleshoot' && (index.h("div", { class: "tab-body" }, index.h("div", null, index.h("div", { class: "stage-indicator" }, "Step ", this.stage + 1, "/2"), this.stage === 0 && (index.h("dyte-debugger-permissions-ui", Object.assign({}, defaults, { mediaType: "video" }))), this.stage === 1 && (index.h("div", null, index.h("div", { class: "title" }, "Camera Test"), index.h("div", { class: "text" }, this.t('Upon starting the Camera Test, a video preview will be enabled for you.')), index.h("dyte-button", { size: "md", onClick: () => this.toggleVideoTest() }, this.videoPreview ? 'Stop' : 'Start', " Camera Test"), this.videoPreview && this.videoMetadata && (index.h("div", { class: "col" }, index.h("div", { class: "sub-title" }, "Device Information", index.h("dyte-information-tooltip", { iconPack: this.iconPack }, index.h("div", { slot: "tootlip-text", class: "tooltip-text" }, Object.keys(this.videoMetadata).map((key) => (index.h("div", null, this.formatLabel(key), ":", index.h("span", null, JSON.stringify(this.videoMetadata[key])))))))), index.h("div", { class: "row" }, index.h("div", { class: "label" }, index.h("span", null, this.t('Device Label')), ":"), index.h("div", { class: "text" }, this.t(this.videoMetadata.label))), index.h("div", { class: "sub-title" }, "Video & Device Analysis", index.h("dyte-information-tooltip", { iconPack: this.iconPack }, index.h("div", { slot: "tootlip-text", class: "tooltip-text" }, index.h("div", null, "Video Score:", index.h("span", null, this.videoTrackStats.videoScore, "/10")), index.h("div", null, "Black Frame Detected:", index.h("span", null, this.boolToStr(this.videoTrackStats.isBlackFrame))), index.h("div", null, "Frozen Frame Detected:", index.h("span", null, this.boolToStr(this.videoTrackStats.isFrozenFrame))), index.h("div", null, "Time:", index.h("span", null, new Date(this.videoTrackStats.timestamp).toLocaleTimeString()))))), index.h("div", { class: "video-container" }, !this.videoPreview && (index.h("div", { class: "no-video-preview" }, index.h("dyte-icon", { icon: this.iconPack.video_off, size: "md" }))), index.h("video", { ref: (el) => (this.videoEl = el), autoPlay: true, playsInline: true, muted: true, class: "video-preview" })), this.getAnalysisStatus()))))), index.h("div", { class: "stage-manager" }, this.stage > 0 && (index.h("div", { class: { 'stage-button': true, disabled: this.mediaPermission !== 'ACCEPTED' }, onClick: () => this.changeStage(this.stage - 1) }, index.h("dyte-icon", { size: "sm", icon: this.iconPack.chevron_left }), "Prev")), this.stage < 1 && (index.h("div", { class: { 'stage-button': true, disabled: this.mediaPermission !== 'ACCEPTED' }, onClick: () => this.changeStage(this.stage + 1) }, "Next", index.h("dyte-icon", { size: "sm", icon: this.iconPack.chevron_right })))))), this.activeTab === 'Report' && (index.h("div", { class: "tab-body" }, index.h("dyte-debugger-issues-ui", Object.assign({}, defaults, { mediaType: "video" }))))));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
...
exports.dyte_debugger_audio = DyteDebuggerAudio$2;
exports.dyte_debugger_screenshare = DyteDebuggerAudio$1;
exports.dyte_debugger_video = DyteDebuggerAudio;
