...
const usePaginatedChat = (meeting) => {
  ...
  return (meeting === null || meeting === void 0 ? void 0 : meeting.meta.viewType) === 'CHAT' ||
    livestream.showLivestream(meeting) ||
...
exports.FlagsmithFeatureFlags = FlagsmithFeatureFlags;
exports.disableSettingSinkId = disableSettingSinkId;
exports.isBreakoutRoomsEnabled = isBreakoutRoomsEnabled;
exports.usePaginatedChat = usePaginatedChat;
