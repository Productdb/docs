...
const DyteCameraToggle = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { title: label }, index.h("dyte-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip", iconPack: this.iconPack, t: this.t }, index.h("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, class: classList, variant: this.variant, label: label, icon: icon, onClick: this.toggleCamera, showWarning: showWarning, disabled: disable }))));
  }
...
exports.dyte_camera_toggle = DyteCameraToggle;
