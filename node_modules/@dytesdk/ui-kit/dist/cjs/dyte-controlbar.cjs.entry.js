...
const DyteControlbar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, !this.disableRender && (index.h(index$2.Render, { element: "dyte-controlbar", defaults: defaults, onlyChildren: true })), index.h("slot", null)));
  }
};
DyteControlbar.style = dyteControlbarCss;

exports.dyte_controlbar = DyteControlbar;
