...
const DyteDebuggerAudio$1 = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "text" }, this.t('Please select a prompt that best describes your issue')), index.h("select", { class: `dyte-select ${this.issueIndex === 0 ? 'disabled' : ''}`, onChange: (e) => this.selectIssue(e.target.value) }, issues.map((issue) => (index.h("option", { value: issue.index }, index.h("span", null, issue.value))))), ((_c = (_b = issues[this.issueIndex]) === null || _b === void 0 ? void 0 : _b.steps) === null || _c === void 0 ? void 0 : _c.length) > 0 && (index.h("div", { class: "sub-title" }, this.t('How to fix this:'))), (_e = (_d = issues[this.issueIndex]) === null || _d === void 0 ? void 0 : _d.steps) === null || _e === void 0 ? void 0 :
      _e.map((step) => (index.h("div", { class: "recommendation" }, index.h("div", null, "\u2022"), this.t(step)))), ((_g = (_f = issues[this.issueIndex]) === null || _f === void 0 ? void 0 : _f.steps) === null || _g === void 0 ? void 0 : _g.length) > 0 &&
      (this.reported ? (index.h("p", { class: "report-link" }, this.t('Your issue has been reported.'))) : (index.h("div", { class: "report-issue" }, index.h("p", { class: "recommendation", ref: (el) => (this.reportEl = el) }, this.t('Still facing the issue?')), index.h("dyte-button", { size: "sm", variant: "secondary", onClick: () => this.reportIssue() }, this.t('Report Now')))))));
  }
};
  ...
  render() {
    ...
    const devices = this.mediaType === 'audio'
      ...
      : this.mediaType === 'video'
        ? ['Camera']
        : [];
    return (index.h(index.Host, null, index.h("h3", null, "Device Permissions"), index.h("div", { class: `info ${this.permission}` }, index.h("dyte-icon", { size: "sm", icon: this.iconPack[permission.icon] }), permission.info), index.h("div", { class: "text" }, permission.text), this.permission === 'ACCEPTED' && devices.length > 0 && (index.h("div", { class: "device-indicator" }, devices.map((device) => {
      var _a;
      return (index.h("div", { class: "device" }, index.h("div", { class: "label" }, "Active ", device), index.h("div", { class: "seperator" }, ":"), index.h("div", { class: "device-name" }, (_a = this.devices[device]) === null || _a === void 0 ? void 0 : _a.label)));
    }), index.h("div", { class: "text" }, this.t('You can change the active devices from settings.')))), steps.length > 0 && index.h("div", { class: "sub-title" }, this.t('How to fix this:')), steps === null || steps === void 0 ? void 0 :
      steps.map((step) => (index.h("div", { class: "recommendation" }, index.h("div", null, "\u2022"), this.t(step)))), image !== '' && (index.h("video", { src: `https://cdn.dyte.in/assets/permissions/${image}`, autoPlay: true, muted: true, loop: true })), this.mediaType !== 'screenshare' && this.permission === 'NOT_REQUESTED' && (index.h("dyte-button", { onClick: () => this.allowPermission() }, "Allow Device Permission"))));
  }
...
const DyteInformationTooltip = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "tooltip-container" }, index.h("dyte-icon", { icon: this.iconPack.info, size: "sm" }), index.h("div", { class: "tooltip" }, index.h("slot", { name: "tootlip-text" })))));
  }
};
DyteInformationTooltip.style = dyteInformationTooltipCss;

exports.dyte_debugger_issues_ui = DyteDebuggerAudio$1;
exports.dyte_debugger_permissions_ui = DyteDebuggerAudio;
exports.dyte_information_tooltip = DyteInformationTooltip;
