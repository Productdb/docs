...
const DyteDebugger = class {
  ...
  close() {
    ...
    store.state.activeDebugger = false;
  }
  getActiveTab() {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("aside", { class: { hide: this.isMobileMainVisible }, part: "menu" }, index.h("header", null, index.h("h3", null, this.t('Troubleshooting'))), index.h("button", { type: "button", class: { active: this.activeTab === 'audio' }, onClick: () => this.changeTab('audio') }, this.t('audio'), index.h("div", { class: "right" }, index.h("dyte-icon", { icon: this.iconPack.mic_on, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && (index.h("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t })))), index.h("button", { type: "button", class: { active: this.activeTab === 'video' }, onClick: () => this.changeTab('video') }, this.t('video'), index.h("div", { class: "right" }, index.h("dyte-icon", { icon: this.iconPack.video_on, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && (index.h("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t })))), index.h("button", { type: "button", class: { active: this.activeTab === 'screenshare' }, onClick: () => this.changeTab('screenshare') }, this.t('Screenshare'), index.h("div", { class: "right" }, index.h("dyte-icon", { icon: this.iconPack.share_screen_start, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && (index.h("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t }))))), index.h("main", { class: { active: this.isMobileMainVisible }, part: "main-content" }, this.size === 'sm' && (index.h("header", null, index.h("dyte-button", { kind: "icon", class: "back-btn", onClick: () => (this.isMobileMainVisible = false), iconPack: this.iconPack, t: this.t }, index.h("dyte-icon", { icon: this.iconPack.chevron_left, iconPack: this.iconPack, t: this.t })), index.h("h4", null, tab))), this.activeTab === 'audio' && index.h("dyte-debugger-audio", Object.assign({}, defaults)), this.activeTab === 'video' && index.h("dyte-debugger-video", Object.assign({}, defaults)), this.activeTab === 'screenshare' && (index.h("dyte-debugger-screenshare", Object.assign({}, defaults))), this.progress > 1 && (index.h("div", { class: "progress-bar" }, index.h("div", { class: "progress-indicator", style: {
        width: `${this.progress}%`,
      } }))))));
  }
};
