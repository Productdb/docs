...
const DyteDraftAttachmentView = class {
  constructor(hostRef) {
    ...
    this.onDeleteAttachment = index.createEvent(this, "deleteAttachment", 7);
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "preview-overlay" }, index.h("div", { class: "preview" }, index.h("dyte-tooltip", { label: this.t('chat.cancel_upload') }, index.h("dyte-button", { variant: "secondary", kind: "icon", onClick: this.onDeleteClickHandler }, index.h("dyte-icon", { icon: this.iconPack.dismiss }))), this.attachment.type === 'image' ? (index.h("img", { class: "preview-image", src: this.filePreview })) : (index.h("div", { class: "preview-file" }, index.h("span", null, this.filePreview)))))));
  }
...
const DyteEmojiPicker = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.pickerClose = index.createEvent(this, "pickerClose", 7);
    this.emojiClicked = index.createEvent(this, "dyteEmojiClicked", 7);
    this.iconPack = defaultIconPack.defaultIconPack;
    this.t = index$1.useLanguage();
  ...
  mapEmojiList() {
    ...
    if (((_a = this.emojiList) === null || _a === void 0 ? void 0 : _a.length) > 0) {
      return (index.h("div", { id: "loader" }, index.h("dyte-spinner", { iconPack: this.iconPack, t: this.t })));
    }
    return (index.h("div", { id: "emoji-grid", class: "scrollbar max-w-40" }, this.filteredEmojis.map((e) => (index.h("dyte-button", { iconPack: this.iconPack, t: this.t, key: `emoji-button-${e.name}`, class: "emoji", variant: "ghost", kind: "icon", title: e.name, onClick: () => this.handleEmojiClick(e.emoji) }, e.emoji)))));
  }
  render() {
    return (index.h(index.Host, null, index.h("div", { class: 'close-parent' }, index.h("dyte-button", { variant: "ghost", kind: "icon", class: "close", onClick: () => { var _a; return (_a = this.pickerClose) === null || _a === void 0 ? void 0 : _a.emit(); }, "aria-label": this.t('close') }, index.h("dyte-icon", { icon: this.iconPack.dismiss }))), index.h("div", { class: 'emoji-parent' }, index.h("input", { value: this.filterVal, onInput: (event) => this.handleInputChange(event.target), placeholder: this.t('search') }), this.mapEmojiList())));
  }
};
...
const DyteEmojiPickerButton = class {
  ...
  render() {
    ...
    return (index.h("dyte-tooltip", Object.assign({ label: this.t('chat.send_emoji') }, uiProps), index.h("dyte-button", { variant: "ghost", kind: "icon", class: { active: this.isActive }, title: this.t('chat.send_emoji'), iconPack: this.iconPack, t: this.t }, index.h("dyte-icon", { icon: this.iconPack.emoji_multiple }))));
  }
};
...
const DyteFilePickerButton = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onFileChange = index.createEvent(this, "fileChange", 7);
    this.uploadFile = () => {
  ...
  render() {
    ...
    return (index.h("dyte-tooltip", Object.assign({ label: label }, uiProps), index.h("dyte-button", { variant: "ghost", kind: "icon", onClick: () => this.uploadFile(), title: label, iconPack: this.iconPack, t: this.t }, index.h("dyte-icon", { icon: icon }))));
  }
};
...
const DyteTextComposerView = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.onTextChange = index.createEvent(this, "textChange", 7);
    this.onInputHandler = () => {
  ...
  render() {
    return (index.h("div", { class: "chat-input", part: "chat-input-container" }, index.h("textarea", { ref: (el) => (this.$textArea = el), placeholder: this.placeholder, disabled: this.disabled, onInput: this.onInputHandler, onKeyDown: this.keyDownHandler, part: "chat-input", value: this.value })));
  }
};
