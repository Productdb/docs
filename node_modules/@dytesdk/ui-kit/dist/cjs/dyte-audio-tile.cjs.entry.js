...
const DyteAudioTile = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: { 'avatar-ctr': true, speaking: this.audioEnabled, [shadowClass]: true } }, index.h("dyte-avatar", { participant: this.participant, size: this.size }, !this.audioEnabled && (index.h("div", { class: "mic-icon" }, index.h("dyte-icon", { icon: defaultIconPack.defaultIconPack.mic_off }))))), index.h("dyte-name-tag", Object.assign({ variant: "text", participant: this.participant }, defaults)), index.h("slot", null)));
  }
...
exports.dyte_audio_tile = DyteAudioTile;
