...
const DyteAi = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("h3", { class: "title" }, this.t('ai')), index.h("div", { id: "mobile-header" }, index.h("dyte-button", { variant: "ghost", class: { active: this.tab === 'home' }, onClick: () => this.viewSection('home'), iconPack: this.iconPack, t: this.t }, this.t('ai.home'), this.newAiMessageAvailable && index.h("span", { class: "dot" }, ".")), index.h("dyte-button", { variant: "ghost", class: { active: this.tab === 'transcriptions' }, onClick: () => this.viewSection('transcriptions'), iconPack: this.iconPack, t: this.t }, this.t('ai.transcriptions'), this.newTranscriptionAvailable && index.h("span", { class: "dot" }, "."))), index.h("dyte-button", { variant: "ghost", kind: "icon", class: "close", onClick: this.close, "aria-label": this.t('close'), iconPack: this.iconPack, t: this.t }, index.h("dyte-icon", { icon: this.iconPack.dismiss, iconPack: this.iconPack, t: this.t })), this.tab === 'home' && (index.h(index$2.Render, { element: "dyte-ai-home", defaults: defaults, props: {
        // aiClient: aiClient,
        // initialMessages: aiClient.aiMesssages,
        meeting: this.meeting,
      } })), this.tab === 'transcriptions' && (index.h(index$2.Render, { element: "dyte-ai-transcriptions", defaults: defaults })), this.tab === 'personal' && index.h(index$2.Render, { element: "dyte-ai-chat", defaults: defaults })));
  }
