...
const DyteParticipantsStaged = class {
  ...
  render() {
    if (this.view !== 'sidebar' || !this.shouldShowStageRequests())
      return;
    return (index.h("div", { class: "stage-requested-participants" }, index.h("div", { class: "heading-count", part: "staged-heading-count" }, this.t('stage_request.header_title'), " (", this.stageRequestedParticipants.length, ")"), index.h("ul", { class: "participants", part: "staged-participants" }, this.stageRequestedParticipants.map((participant) => (index.h("li", { class: "waiting-participant", key: participant.id }, index.h("div", { class: "participant-details" }, index.h("dyte-avatar", { participant: participant, size: "sm", iconPack: this.iconPack, t: this.t }), index.h("p", { class: "name", title: participant.name }, participant.name)), index.h("div", { class: "waitlist-controls" }, index.h("dyte-tooltip", { label: this.t('stage_request.deny_request'), variant: "secondary", iconPack: this.iconPack, t: this.t }, index.h("dyte-button", { variant: "secondary", kind: "icon", onClick: () => this.rejectStageRequest(participant), iconPack: this.iconPack, t: this.t }, index.h("dyte-icon", { class: "deny", icon: this.iconPack.dismiss, iconPack: this.iconPack, t: this.t }))), index.h("dyte-tooltip", { label: this.t('stage_request.accept_request'), variant: "secondary", iconPack: this.iconPack, t: this.t }, index.h("dyte-button", { variant: "secondary", kind: "icon", iconPack: this.iconPack, t: this.t, onClick: () => this.acceptStageRequest(participant) }, index.h("dyte-icon", { class: "accept", icon: this.iconPack.checkmark })))))))), index.h("div", { class: "bulk-actions" }, index.h("dyte-button", { class: "accept-all-button", variant: "secondary", iconPack: this.iconPack, t: this.t, onClick: this.acceptAllStageRequest }, this.t('stage_request.accept_all')), index.h("dyte-button", { class: "deny-all-button", variant: "danger", iconPack: this.iconPack, t: this.t, onClick: this.denyAllStageRequest }, this.t('stage_request.deny_all')))));
  }
...
exports.dyte_participants_stage_queue = DyteParticipantsStaged;
