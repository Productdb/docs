...
const hark = require('./hark-4ba56a46.js');
...
const DyteAudioVisualizer = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("canvas", { width: "24", height: "24", class: {
        bars: true,
        visible: this.audioEnabled,
      }, ref: (el) => (this.visualizer = el), part: "canvas" }), !this.isScreenShare && !this.audioEnabled && (index.h("dyte-icon", { icon: this.iconPack.mic_off, part: "mic-off-icon", iconPack: this.iconPack, t: this.t }))));
  }
...
const DyteSwitch = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.dyteChange = index.createEvent(this, "dyteChange", 4);
    this.onClick = () => {
  ...
  render() {
    return (index.h(index.Host, { role: "switch", tabIndex: this.disabled && 0, "aria-readonly": this.readonly, "aria-checked": this.checked, "aria-disabled": this.disabled, class: { checked: this.checked }, onClick: this.onClick, onKeyPress: this.onKeyPress }, index.h("div", { class: "switch", part: "switch" })));
  }
  static get watchers() { return {
