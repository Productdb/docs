...
const DyteSettings = class {
  ...
  close() {
    ...
    store.state.activeSettings = false;
  }
  render() {
    ...
    return (index.h(index.Host, null, index.h("aside", { class: { hide: this.isMobileMainVisible }, part: "menu" }, index.h("header", null, index.h("h2", null, this.t('settings'))), index.h("button", { type: "button", class: { active: this.activeTab === 'audio' }, onClick: () => this.changeTab('audio') }, this.t('audio'), index.h("div", { class: "right" }, index.h("dyte-icon", { icon: this.iconPack.mic_on, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && (index.h("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t })))), this.canProduceVideo && (index.h("button", { type: "button", class: { active: this.activeTab === 'video' }, onClick: () => this.changeTab('video') }, this.t('video'), index.h("div", { class: "right" }, index.h("dyte-icon", { icon: this.iconPack.video_on, iconPack: this.iconPack, t: this.t }), this.size === 'sm' && (index.h("dyte-icon", { icon: this.iconPack.chevron_right, iconPack: this.iconPack, t: this.t }))))), index.h("button", { type: "none", title: `Your network condition is ${this.networkStatus}` }, this.t('connection'), index.h("div", { class: "right" }, index.h("dyte-icon", { icon: this.iconPack.wifi, class: this.networkStatus, iconPack: this.iconPack, t: this.t })))), index.h("main", { class: { active: this.isMobileMainVisible, scrollbar: true }, part: "main-content" }, this.size === 'sm' && (index.h("header", null, index.h("dyte-button", { kind: "icon", class: "back-btn", onClick: () => (this.isMobileMainVisible = false), iconPack: this.iconPack, t: this.t }, index.h("dyte-icon", { icon: this.iconPack.chevron_left, iconPack: this.iconPack, t: this.t })), index.h("h2", null, this.t(this.activeTab === 'audio' ? 'audio' : 'video')))), this.activeTab === 'audio' && index.h("dyte-settings-audio", Object.assign({}, defaults)), this.activeTab === 'video' && index.h("dyte-settings-video", Object.assign({}, defaults)))));
  }
