 ...
 */
const extendConfig = (config, baseConfig = defaultUiConfig.defaultConfig) => {
...
const generateConfig = (oldConfig, meeting, toExtend = {}, options = { grid_pagination: true, settings_toggle: true }) => {
  ...
  if ((_a = oldConfig.controlBar) === null || _a === void 0 ? void 0 : _a.isEnabled) {
    ...
    if (livestream.isLiveStreamHost(meeting)) {
...
exports.merge = merge;
exports.provideDyteDesignSystem = provideDyteDesignSystem;
