...
const DyteMoreToggle = class {
  constructor(hostRef) {
    ...
    this.handleKeyDown = ({ key }) => {
      if (key === 'Escape' && this.states.activeMoreMenu) {
        ...
        store.state.activeMoreMenu = !store.state.activeMoreMenu;
      }
    };
    ...
    this.toggleMoreMenu = () => {
      this.stateUpdate.emit({ activeMoreMenu: !store.state.activeMoreMenu });
      store.state.activeMoreMenu = !store.state.activeMoreMenu;
    };
  ...
  render() {
    ...
    return (index.h(index.Host, { title: text }, this.states.activeMoreMenu && (index.h("div", { class: "more-menu" }, index.h("slot", { name: "more-elements" }))), index.h("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, t: this.t, onClick: (e) => {
        e.stopPropagation();
        this.toggleMoreMenu();
      }, icon: this.iconPack.horizontal_dots, label: text, part: "controlbar-button" }), index.h("slot", { name: "expanded" })));
  }
