...
export const isBreakoutRoomsEnabled = (meeting) => meeting.connectedMeetings.supportsConnectedMeetings;
export const usePaginatedChat = (meeting) => {
  var _a;
...
export const disableSettingSinkId = (meeting) => {
  var _a, _b;
