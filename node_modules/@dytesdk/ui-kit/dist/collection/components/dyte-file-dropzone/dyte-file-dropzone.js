...
export class DyteFileDropzone {
  ...
  static get is() { return "dyte-file-dropzone"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-file-dropzone.css"]
    };
  }
  ...
  static get properties() {
    return {
      "hostEl": {
        ...
        "docs": {
          "tags": [],
          "text": "Host element on which drop events to attach"
        }
      },
      "iconPack": {
        "type": "unknown",
