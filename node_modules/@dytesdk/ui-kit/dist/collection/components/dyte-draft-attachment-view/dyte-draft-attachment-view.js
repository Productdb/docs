...
export class DyteDraftAttachmentView {
  ...
  static get is() { return "dyte-draft-attachment-view"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-draft-attachment-view.css"]
    };
  }
  ...
  static get events() {
    return [{
        ...
        "docs": {
          "tags": [],
          "text": "Event triggered when the attachment is deleted"
        },
        "complexType": {
          "original": "any",
          "resolved": "any",
