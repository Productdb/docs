...
export class DyteFilePickerButton {
  ...
  static get is() { return "dyte-file-picker-button"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-file-picker-button.css"]
    };
  }
  ...
  static get properties() {
    return {
      "filter": {
        ...
        "docs": {
          "tags": [],
          "text": "File type filter to open file picker with"
        },
        "attribute": "filter",
        "reflect": false
      },
  ...
  static get events() {
    return [{
        ...
        "docs": {
          "tags": [],
          "text": "Event when a file is selected for upload"
        },
        "complexType": {
          "original": "File",
          "resolved": "File",
