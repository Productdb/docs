...
export class DyteChatSelectorUi {
  ...
  static get is() { return "dyte-chat-selector-ui"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-chat-selector-ui.css"]
    };
  }
  ...
  static get properties() {
    return {
      ...
      "selectedGroupId": {
        ...
        "docs": {
          "tags": [],
          "text": "Selected participant"
        },
        "attribute": "selected-group-id",
        "reflect": false
      },
      "unreadCounts": {
        "type": "unknown",
  ...
  static get events() {
    return [{
        "method": "groupChanged",
        "name": "dyteChatGroupChanged",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
          "tags": [],
          "text": "Event emitted when chat scope is changed"
        },
        "complexType": {
