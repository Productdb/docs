...
export class DyteJoinStage {
  ...
  static get is() { return "dyte-join-stage"; }
  ...
  static get events() {
    return [{
        ...
        "docs": {
          "tags": [],
          "text": "Event which is emitted when user confirms joining stage"
        },
        "complexType": {
          "original": "void",
          "resolved": "void",
        ...
        "docs": {
          "tags": [],
          "text": "Event which is emitted when user cancel joining stage"
        },
        "complexType": {
          "original": "void",
          "resolved": "void",
