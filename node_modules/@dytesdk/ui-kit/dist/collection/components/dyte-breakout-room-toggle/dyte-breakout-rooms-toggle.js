...
export class DyteBreakoutRoomsToggle {
  constructor() {
    this.breakoutRoomToggle = () => {
      ...
      storeState.activeBreakoutRoomsManager = {
        active: !((_c = storeState.activeBreakoutRoomsManager) === null || _c === void 0 ? void 0 : _c.active),
        mode,
      };
    };
    this.variant = 'button';
  ...
  static get is() { return "dyte-breakout-rooms-toggle"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-breakout-rooms-toggle.css"]
    };
  }
