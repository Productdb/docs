...
export class DyteChannelHeader {
  ...
  static get is() { return "dyte-channel-header"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-channel-header.css"]
    };
  }
  ...
  static get events() {
    return [{
        ...
        "docs": {
          "tags": [],
          "text": "event triggered for search"
        },
        "complexType": {
          "original": "string",
          "resolved": "string",
        ...
        "method": "searchDismissed",
        "name": "searchDismissed",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "docs": {
          "tags": [],
          "text": "Event emitted when back button is clicked"
        },
        "complexType": {
          "original": "void",
          "resolved": "void",
