...
import { defaultIconPack, defaultConfig } from '../../exports';
...
export class DyteParticipantsWaitlisted {
  ...
  static get is() { return "dyte-participants-waiting-list"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["dyte-participants-waiting-list.css"]
    };
  }
  ...
  static get properties() {
    return {
      ...
      "view": {
        ...
        "docs": {
          "tags": [],
          "text": "View mode for participants list"
        },
        "attribute": "view",
        "reflect": false,
