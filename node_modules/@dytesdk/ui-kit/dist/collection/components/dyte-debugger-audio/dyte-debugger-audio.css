...
.NOT_REQUESTED {
  ...
  color: rgba(var(--dyte-colors-warning, 255 205 7) / var(--tw-text-opacity)) !important;
  opacity: 0.8;
}
...
.ACCEPTED {
  --tw-text-opacity: 1 !important;
  color: rgba(var(--dyte-colors-success, 98 165 4) / var(--tw-text-opacity)) !important;
  opacity: 0.8;
}
...
.SYSTEM_DENIED {
  --tw-text-opacity: 1 !important;
  color: rgba(var(--dyte-colors-danger, 255 45 45) / var(--tw-text-opacity)) !important;
  opacity: 0.8;
}
...
.tooltip-text span {
  ...
  color: rgb(var(--dyte-colors-text-900, 255 255 255 / 0.88)) !important;
}
...
.row dyte-switch {
  margin-left: var(--dyte-space-8, 32px);
}
.row dyte-button {
  margin-top: var(--dyte-space-1, 4px);
  margin-bottom: var(--dyte-space-1, 4px);
...
.volume-level {
  ...
  --tw-bg-opacity: 1;
  background-color: rgba(var(--dyte-colors-brand-400, 53 110 253) / var(--tw-bg-opacity));
...
.stage-manager {
  ...
  font-size: 14px;
  --tw-text-opacity: 1;
  color: rgba(var(--dyte-colors-brand-600, 13 81 253) / var(--tw-text-opacity));
}
...
.stage-button dyte-icon {
  padding: var(--dyte-space-0, 0px);
}

.disabled {
  cursor: not-allowed;
  color: rgb(var(--dyte-colors-text-600, 255 255 255 / 0.52)) !important;
}
...
#header dyte-button {
  border-bottom: var(--dyte-border-width-md, 2px) solid transparent;
  border-radius: var(--dyte-border-radius-none, 0);
}

#header dyte-button:hover {
  background-color: transparent;
}

#header dyte-button.active {
  border-color: rgb(var(--dyte-colors-brand-400, 53 110 253));
}
