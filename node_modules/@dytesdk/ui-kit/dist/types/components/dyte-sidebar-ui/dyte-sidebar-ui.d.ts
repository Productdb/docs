...
import { DyteI18n } from '../../exports';
export interface DyteSidebarTab {
  id: string;
  name: string;
}
export declare type DyteSidebarView = 'sidebar' | 'full-screen';
export declare class DyteSidebarUi {
  ...
  iconPack: {
    ...
    signal_4: string;
    signal_5: string;
    start_livestream: string;
    stop_livestream: string;
    viewers: string;
    debug: string;
    info: string;
    devices: string;
  ...
  /** Tab change event */
  sidebarClose: EventEmitter<void>;
  private onClose;
  render(): any;
}
