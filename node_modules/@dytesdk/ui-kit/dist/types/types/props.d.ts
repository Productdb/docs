...
export declare type NetworkError = 'disconnected' | 'poorConnection' | 'connected';
export declare type SocketEvents = 'connected' | 'disconnected' | 'reconnecting' | 'reconnectAttempt' | 'reconnectFailure' | 'reconnected' | 'failed';
...
export declare type Chat = ChatMessage | PluginMessage;
export declare type ConnectedMeeting = {
  id: string;
  title: string;
  participants: string[];
  isMainRoom?: boolean;
...
export declare type ConnectedMeetingState = {
  parentMeeting: {
    id: string;
    title: string;
...
export declare type ChatChannel = ChatChannelWebCore;
