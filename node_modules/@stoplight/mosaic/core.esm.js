...
import cn$1 from 'clsx';
import * as React from 'react';
import React__default, { forwardRef, memo, useState, useCallback, useEffect, useRef, useContext, useMemo, useLayoutEffect as useLayoutEffect$1, useImperativeHandle, createElement } from 'react';
import memoize from 'nano-memoize';
import equals from 'react-fast-compare';
import useResizeObserver from 'use-resize-observer';
import copy from 'copy-to-clipboard';
import { parseToHsl, parseToRgb, rgba, getLuminance, getContrast, mix, readableColor as readableColor$1 } from 'polished';
import _reactDom, { unstable_batchedUpdates, createPortal, flushSync } from 'react-dom';
...
const _ringProps = memoize((ring, ringColor, ringOpacity) => {
  return cn$1(computePseudoClasses('ring', ring), computePseudoClasses('ring', ringColor), computePseudoClasses('ring-opacity', ringOpacity));
}, {
  maxAge: Infinity,
  equals
});
...
const _colorProps = memoize((color, bg, placeholderColor) => {
  return cn$1(computePseudoClasses('bg', bg), computePseudoClasses('text', color), computePseudoClasses('placeholder', placeholderColor));
}, {
  maxAge: Infinity,
  equals
});

const isResponsiveObject = obj => obj && typeof obj === 'object';
function computeResponsiveClasses(prop, val) {
  let classes = {}; // if val is literal true value, then we're trying to use default and do not need to append a value
  // val can be 0, account for this
  ...
  if (isResponsiveObject(val)) {
    ...
    classes[buildClassname(prop, val)] = val !== void 0;
  }
...
const flexWrapProp = flexWrap => {
  if (isResponsiveObject(flexWrap)) {
    const newResponsiveProp = {};
...
const _flexProps = memoize((flex, flexDirection, flexWrap, flexGrow, flexShrink, justifyContent, justifyItems, justifySelf, alignContent, alignItems, alignSelf) => {
  return cn$1({
    ...
    [computeResponsiveClasses('flex-grow', flexGrow === true ? true : isResponsiveObject(flexGrow) ? flexGrow : '0')]: flexGrow !== void 0,
    [computeResponsiveClasses('flex-shrink', flexShrink === true ? true : isResponsiveObject(flexShrink) ? flexShrink : '0')]: flexShrink !== void 0,
...
const _interactivityProps = memoize((cursor, userSelect, pointerEvents, opacity, resize, visibility) => {
  ...
  computePseudoClasses('', visibility), computeResponsiveClasses('', visibility), computePseudoClasses('opacity', opacity));
}, {
  maxAge: Infinity,
  equals
});
...
const _layoutProps = memoize((display, overflowX, overflowY, objectFit, objectPosition) => {
  return cn$1({
    [computeResponsiveClasses('', display)]: display !== void 0,
...
const _shadowProps = memoize(boxShadow => {
  return cn$1(computePseudoClasses('shadow', boxShadow));
}, {
  maxAge: Infinity,
  equals
});
...
const _sizeProps = memoize((h, maxH, minH, w, maxW, minW) => {
  return cn$1({
    [computeResponsiveClasses('w', w)]: w !== void 0,
    [computeResponsiveClasses('max-w', maxW)]: maxW !== void 0,
    [computeResponsiveClasses('min-w', minW)]: minW !== void 0,
    [computeResponsiveClasses('h', h)]: h !== void 0,
    [computeResponsiveClasses('max-h', maxH)]: maxH !== void 0,
    [computeResponsiveClasses('min-h', minH)]: minH !== void 0
  });
}, {
  maxAge: Infinity,
  equals
...
const Box = /*#__PURE__*/forwardRef(function Box({
  ...
  const _className = cn$1(className, classNames, {
    'sl-group': role === 'group',
...
const Container = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Container({
  ...
  return jsx(Box, Object.assign({
    ...
    className: cn$1('Container', className)
  }, props), void 0);
}));
...
const Article = /*#__PURE__*/memo(function Article({
  ...
  return jsx(Container, Object.assign({
    as: "article",
    className: cn$1('sl-article', className),
    size: "md",
    py: 20
  }, props, {
    children: children
...
function AspectRatio({
  ...
  return jsx(Box, Object.assign({}, props, {
    pos: "relative",
    className: cn$1('sl-aspect-ratio', className),
    style: { ...style,
...
const randomColorFromString = (str, $opts) => {
  try {
    var h, s, l;
    const opts = $opts || {}; // allow any hue

    opts.h = opts.h || [0, 360]; // limit saturation - we generally like saturation to keep things "pop-y", but too much saturation and white text gets difficult to read

    opts.s = opts.s || [60, 80]; // ditto above re carefully selecting the range here to balance variability with readability of white text
...
const readableColor = (color, leeway = 0) => {
  const white = '#fff';
  const black = '#000';

  try {
    const whiteContrast = getContrast(color, white);
    const blackContrast = getContrast(color, black); // Prefer white as a contrast color if it is within {leeway} units of black
 ...
 */
function splitDatasetProps(props) {
  const matchedProps = {};
  const remainingProps = {};
...
const computeTheme = (customTheme, $mode = 'system') => {
  ...
  const cv = {
    ...
    text: theme.colors.text ? parseHsl(theme.colors.text) : parseHsl(readableColor$1(stringifyHsl(backgroundHsl), stringifyHsl({
      h: backgroundHsl.h,
      s: backgroundHsl.s,
...
function SSRProvider(props) {
  ...
  return /*#__PURE__*/React__default.createElement($f01a183cc7bdff77849e49ad26eb904$var$SSRContext.Provider, {
    value: value
  }, props.children);
}
  ...
  for (let props of args) {
    for (let key in result) {
      ...
      if (/^on[A-Z]/.test(key) && typeof result[key] === 'function' && typeof props[key] === 'function') {
        ...
        result[key] = cn$1(result.className, props.className);
      } else if (key === 'UNSAFE_className' && typeof result.UNSAFE_className === 'string' && typeof props.UNSAFE_className === 'string') {
        result[key] = cn$1(result.UNSAFE_className, props.UNSAFE_className);
...
const $f838b598b03ac1d3fd85d427f7d189$var$Context = /*#__PURE__*/React__default.createContext(null);
...
const MosaicContext = /*#__PURE__*/React.createContext(defaultMosaicContext);

const useMosaicContext = () => {
  return useContext(MosaicContext);
};

const $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c$3 = typeof window !== 'undefined' ? React__default.useLayoutEffect : ()=>{
};




let $bdb11010cef70236$var$idsUpdaterMap$2 = new Map();
...
function $3ef42575df84b30b$export$9d1611c77c2fe928$2(...args) {
    ...
    for(let i = 1; i < args.length; i++){
        ...
        for(let key in props){
            ...
            else if ((key === 'className' || key === 'UNSAFE_className') && typeof a === 'string' && typeof b === 'string') result[key] = cn$1(a, b);
...
// than one or the other. So we need to track what's actually transitioning so that
// we can ignore these duplicate events.
let $bbed8b41f857bcc0$var$transitionsByElement$3 = new Map();
// A list of callbacks to call once there are no transitioning elements.
let $bbed8b41f857bcc0$var$transitionCallbacks$3 = new Set();
function $bbed8b41f857bcc0$var$setupGlobalEvents$3() {
    if (typeof window === 'undefined') return;
    let onTransitionStart = (e)=>{
        // Add the transitioning property to the list for this element.
        let transitions = $bbed8b41f857bcc0$var$transitionsByElement$3.get(e.target);
        if (!transitions) {
            transitions = new Set();
            $bbed8b41f857bcc0$var$transitionsByElement$3.set(e.target, transitions);
    ...
    let onTransitionEnd = (e)=>{
        // Remove property from list of transitioning properties.
        let properties = $bbed8b41f857bcc0$var$transitionsByElement$3.get(e.target);
        if (!properties) return;
        properties.delete(e.propertyName);
        // If empty, remove transitioncancel event, and remove the element from the list of transitioning elements.
        if (properties.size === 0) {
            e.target.removeEventListener('transitioncancel', onTransitionEnd);
            $bbed8b41f857bcc0$var$transitionsByElement$3.delete(e.target);
        }
        // If no transitioning elements, call all of the queued callbacks.
        if ($bbed8b41f857bcc0$var$transitionsByElement$3.size === 0) {
            for (let cb of $bbed8b41f857bcc0$var$transitionCallbacks$3)cb();
...
if (typeof document !== 'undefined') {
    if (document.readyState !== 'loading') $bbed8b41f857bcc0$var$setupGlobalEvents$3();
    else document.addEventListener('DOMContentLoaded', $bbed8b41f857bcc0$var$setupGlobalEvents$3);
}
function $bbed8b41f857bcc0$export$24490316f764c430(fn) {
    ...
    requestAnimationFrame(()=>{
        // If no transitions are running, call the function immediately.
        // Otherwise, add it to a list of callbacks to run at the end of the animation.
        if ($bbed8b41f857bcc0$var$transitionsByElement$3.size === 0) fn();
        else $bbed8b41f857bcc0$var$transitionCallbacks$3.add(fn);
    });
}
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
            ...
            onClick (e) {
                ...
                if (e && e.button === 0) {
                    ...
                    if (!state.ignoreClickAfterPress && !state.ignoreEmulatedMouseEvents && (state.pointerType === 'virtual' || $8a9cb279dc87e130$export$60278871457622de(e.nativeEvent))) {
                        ...
                        if (!isDisabled1 && !preventFocusOnPress) $7215afc6de606d6b$export$de79e2c695e052f3$1(e.currentTarget);
    ...
    return {
        ...
        pressProps: $3ef42575df84b30b$export$9d1611c77c2fe928$2(domProps, pressProps1)
    };
}
...
const $3b117e43dc0ca95d$export$27c701ed9e449e99 = /*#__PURE__*/ React__default.forwardRef(({ children: children , ...props }, ref)=>{
    ...
    return(/*#__PURE__*/ React__default.cloneElement(child, // @ts-ignore
    {
        ref: ref,
        ...$3ef42575df84b30b$export$9d1611c77c2fe928$2(child.props, pressProps)
    }));
});
...
const $f1ab8c75478c6f73$export$3351871ee4b288b8 = /*#__PURE__*/ React__default.forwardRef(({ children: children , ...props }, ref)=>{
    ...
    let context = $3ef42575df84b30b$export$9d1611c77c2fe928$2(prevContext || {
    }, {
        ...props,
...
function useOverlay(props, ref) {
  ...
  let onInteractOutsideStart = e => {
    if (!shouldCloseOnInteractOutside || shouldCloseOnInteractOutside(e.target)) {
      const modality = $507fabe10e71c6fb$export$630ff653c5ada6a9();
...
const $b876e5ac9c98db373bf726bce3d604e$var$Context = /*#__PURE__*/React__default.createContext(null);
/**
...
function ModalProvider(props) {
  ...
  return /*#__PURE__*/React__default.createElement($b876e5ac9c98db373bf726bce3d604e$var$Context.Provider, {
    value: context
  }, children);
}
...
function OverlayProvider(props) {
  return /*#__PURE__*/React__default.createElement(ModalProvider, null, /*#__PURE__*/React__default.createElement($b876e5ac9c98db373bf726bce3d604e$var$OverlayContainerDOM, props));
}
...
const useSafeEffect = typeof window !== 'undefined' ? useLayoutEffect$1 : useEffect;
...
const InvertThemeContext = /*#__PURE__*/React.createContext({});
const InvertTheme = ({
  children,
  inverted
}) => {
  ...
  const _className = cn$1(children.props.className, {
...
// NOTE: adapted from chakra-ui `useImage` hook
/**
...
function useImage(props) {
  ...
  }, [src, crossOrigin, onLoad, onError, loading]);
...
const Flex = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Flex({
  align,
  justify,
  wrap,
  direction,
...
const initLibrary = () => {
  library.add(faCaretDown, faCaretLeft, faCaretRight, faCaretUp, faCheck, faChevronDown, faChevronLeft, faChevronRight, faChevronUp, faCopy, faExclamationCircle, faExclamationTriangle, faExpandArrowsAlt, faExternalLinkAlt, faInfoCircle, faLink, faSort, faStream, faUser);
  addedToLibrary = true;
};
...
const Icon = /*#__PURE__*/memo(function Icon({
  ...
  if (isIconDefinition(iconProp) || findIconDefinition(iconProp)) {
    return jsx(FontAwesomeIcon, Object.assign({
      className: cn$1(_className, className),
      icon: iconProp
    }, props), void 0);
  ...
  return jsx("i", {
    role: "img",
    "aria-hidden": "true",
    className: cn$1(_className, className, iconProp.prefix, `fa-${iconProp.iconName}`, {
      'fa-spin': props.spin,
...
function Image$1({
  ...
  return jsx(Box, Object.assign({
    as: ImageOverride || defaultElement$b,
    className: cn$1('sl-image', className, {
...
const $c9e8f80f5bb1841844f54e4ad30b$var$FocusContext = /*#__PURE__*/React__default.createContext(null);
...
function FocusScope(props) {
  ...
  return /*#__PURE__*/React__default.createElement($c9e8f80f5bb1841844f54e4ad30b$var$FocusContext.Provider, {
    value: focusManager
...
function FocusRing(props) {
  ...
  return /*#__PURE__*/React__default.cloneElement(child, mergeProps(child.props, _extends({}, focusProps, {
    className: cn$1({
...
let $e11539c8317b2d21639df611cb5658f$var$FocusableContext = /*#__PURE__*/React__default.createContext(null);
...
function $e11539c8317b2d21639df611cb5658f$var$FocusableProvider(props, ref) {
  ...
  return /*#__PURE__*/React__default.createElement($e11539c8317b2d21639df611cb5658f$var$FocusableContext.Provider, {
    value: context
  }, children);
}

let FocusableProvider = /*#__PURE__*/React__default.forwardRef($e11539c8317b2d21639df611cb5658f$var$FocusableProvider);
...
function Button({
  ...
  const stateProps = { ...variants$6.default.default,
    ...variants$6.default[intent],
    ...((_a = variants$6[appearance]) === null || _a === void 0 ? void 0 : _a.default),
    ...((_b = variants$6[appearance]) === null || _b === void 0 ? void 0 : _b[intent])
  };
  /**
  ...
  const elem = jsxs(Box, Object.assign({
    as: defaultElement$a,
    px: (_c = sizes$a[size]) === null || _c === void 0 ? void 0 : _c.px,
    fontSize: (_d = sizes$a[size]) === null || _d === void 0 ? void 0 : _d.fontSize,
    fontWeight: "medium",
    rounded: (_e = sizes$a[size]) === null || _e === void 0 ? void 0 : _e.rounded,
    h: size,
    borderColor: "button",
    className: cn$1('sl-button', 'sl-form-group-border', className),
...
const ButtonIcon = ({
  ...
  return jsx(Box, Object.assign({
    mr: hasContent ? (_a = sizes$a[size]) === null || _a === void 0 ? void 0 : _a.leftIconMr : undefined,
    mx: hasContent ? undefined : (_b = sizes$a[size]) === null || _b === void 0 ? void 0 : _b.leftIconMx
  }, {
    children: elem
  }), void 0);
};
...
const ButtonRightIcon = ({
  ...
  return jsx(Box, Object.assign({
    ml: (_a = sizes$a[size]) === null || _a === void 0 ? void 0 : _a.rightIconMl,
    mr: (_b = sizes$a[size]) === null || _b === void 0 ? void 0 : _b.rightIconMr,
    fontSize: (_c = sizes$a[size]) === null || _c === void 0 ? void 0 : _c.iconSize
  }, {
    children: elem
  }), void 0);
};

const defaultElement$9 = 'div';
const ButtonGroup = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function ButtonGroup({
  children,
  className,
  ...rest
}, ref) {
  return jsx(Flex, Object.assign({
    ...
    justifyItems: "start",
    alignItems: "center",
    className: cn$1('sl-button-group', className),
    ref: ref
  }, {
    children: children
  }), void 0);
    ...
    children: [jsx(_Button, Object.assign({
      ...
      children: jsxs(Flex, Object.assign({
        ...
        children: [jsx(Box, Object.assign({
          ...
          children: isNil(children) ? placeholder : /*#__PURE__*/React.isValidElement(children) ? children : String(children)
...
let _Overlay = /*#__PURE__*/React.forwardRef(Overlay);
...
const ModalWrapper = ({
  ...
  const ref = useRef();
  const preventClosingFunction = React.useMemo(preventClosingForShortTime, [isOpen]); // Handle interacting outside the dialog and pressing
...
const ModalBox = /*#__PURE__*/forwardRef(function ModalBox({
  isDraggable,
  moveProps = {},
  containerProps,
  dialogProps,
...
const ModalContent = /*#__PURE__*/memo(function ModalContent({
  children,
  id,
  p,
  h,
...
const StaticModalBox = /*#__PURE__*/forwardRef(function StaticModalBox(props, ref) {
...
const DraggableModalBox = /*#__PURE__*/forwardRef(function DraggableModalBox(props, ref) {
...
function ProductImage({
  ...
  const imageElem = /*#__PURE__*/React.cloneElement(child, {
    bg: 'canvas-pure',
    borderColor: 'body',
    overflowX: 'hidden',
    overflowY: 'hidden',
  ...
  return jsxs(Fragment, {
    children: [jsx($3b117e43dc0ca95d$export$27c701ed9e449e99, Object.assign({
      onPress: open
    }, {
      children: jsxs(Box, Object.assign({
        ...
        children: [jsxs(Box, Object.assign({
          className: cn$1('sl-product-image', className),
          border: 2,
          borderColor: "body",
          rounded: "xl",
      ...
      children: jsx(Box, Object.assign({
        as: $3b117e43dc0ca95d$export$27c701ed9e449e99,
        onPress: close,
        cursor: "zoom-out",
        overflowX: "hidden",
        overflowY: "hidden",
...
const Avatar = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Avatar(props, ref) {
  ...
  if (showFallback && !isBlank) {
    if (icon) {
      ...
      innerElem = jsx(Box, {
        children: letter ? letter : initials(name, size !== 'lg')
      }, void 0);
    } else {
      innerElem = jsx(Icon, {
        icon: "user",
    ...
    innerElem = jsx(Image$1, {
      src: src,
      alt: noTitleAlt ? undefined : name,
      objectFit: "cover",
      w: "full",
      h: "full",
      rounded: "full"
  ...
  return jsx(Flex, Object.assign({
    ref: ref,
    className: cn$1('sl-avatar', {
      'sl-avatar--with-bg': !isBlank
    }, className),
    align: "center",
    justify: "center",
    pos: "relative",
    title: noTitleAlt ? undefined : name,
    fontSize: icon ? (_a = sizes$8[size]) === null || _a === void 0 ? void 0 : _a[2] : (_b = sizes$8[size]) === null || _b === void 0 ? void 0 : _b[1],
    rounded: "full",
    lineHeight: "none",
    fontWeight: "semibold",
    userSelect: "none",
    ...
    flexShrink: 0,
    style: {
      width: (_c = sizes$8[size]) === null || _c === void 0 ? void 0 : _c[0],
      height: (_d = sizes$8[size]) === null || _d === void 0 ? void 0 : _d[0],
...
const convertToFlexDirection = direction => {
  if (isObject(direction)) {
    for (const [key, value] of Object.entries(direction)) {
      direction[key] = directionToFlex[value];
    }

    return direction;
  }

  return directionToFlex[direction];
};

const Stack = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Stack({
  className,
  spacing,
  direction = 'vertical',
  divider,
  ...
  const _className = cn$1('sl-stack', {
    [computeResponsiveClasses('stack-', direction)]: spacing !== void 0,
    [computeResponsiveClasses('stack-', spacing)]: spacing !== void 0
  }, className);
  ...
  if (childrenWithoutNulls && hasDivider) {
    ...
    clones = React.Children.map(childrenWithoutNulls, (child, index) => {
      ...
      const clonedDivider = typeof divider === 'boolean' ? jsx(Box, {
        ...
        alignSelf: "stretch"
      }, "d") : /*#__PURE__*/React.cloneElement(divider, {
        key: 'd'
      });
  ...
  return jsx(Flex, Object.assign({
    ...
    direction: convertToFlexDirection(direction)
  }, restProps, {
    children: clones
  }), void 0);
}));
const HStack = /*#__PURE__*/forwardRef(function HStack(props, ref) {
...
const VStack = /*#__PURE__*/forwardRef(function VStack(props, ref) {
  return jsx(Stack, Object.assign({
    align: "stretch"
  }, props, {
    ref: ref,
...
const AvatarList = function AvatarList(props) {
  var _a, _b;
  ...
  const itemRenderer = (itemProps, key) => {
    const itemElem = /*#__PURE__*/createElement(Avatar, { ...itemProps,
      size: size,
      key: key
    });
  ...
  const WrapperElem = React.useMemo(() => /*#__PURE__*/React.forwardRef(function WrapperElem(wrapperProps, wrapperRef) {
    return jsx(HStack, Object.assign({}, wrapperProps, {
      spacing: spacing,
      ref: wrapperRef
    }), void 0);
  }), [spacing]);

  const overflowRenderer = overflowItemProps => {
    var _a, _b, _c;
    ...
    const overflowNodeProps = {
      style: {
        border: '1px solid',
        borderColor: color,
        color,
        backgroundColor,
        width: (_a = sizes$8[size]) === null || _a === void 0 ? void 0 : _a[0],
        height: (_b = sizes$8[size]) === null || _b === void 0 ? void 0 : _b[0]
      }
    };

    const overflowElem = jsxs(Flex, Object.assign({
      className: cn$1('sl-avatar'),
      align: "center",
      justify: "center",
      title: noTitleAlt && String(overflowItemProps.length),
      fontSize: (_c = sizes$8[size]) === null || _c === void 0 ? void 0 : _c[1],
      rounded: "full",
      lineHeight: "none",
      fontWeight: "semibold",
      userSelect: "none",
      ...
      children: ["+", overflowItemProps.length]
    }), void 0);

    return props.overflowRendererOverride ? props.overflowRendererOverride(overflowItemProps, overflowElem) : overflowElem;
  };

  const innerItems = (_b = (_a = props.items) === null || _a === void 0 ? void 0 : _a.map(i => {
    var _a;

    return { ...i,
      isInverted: (_a = i.isInverted) !== null && _a !== void 0 ? _a : isInverted,
      noTitleAlt
    };
  })) !== null && _b !== void 0 ? _b : [];

  if (typeof maxVisibleItems !== 'number' || maxVisibleItems < 0) {
    return jsx(OverflowList, {
      items: innerItems,
    ...
    return /*#__PURE__*/React.createElement(WrapperElem, {}, [...visibleItems.map(itemRenderer), overflowItems.length > 0 ? overflowRenderer(overflowItems) : null]);
  }
};
...
const Tooltip = props => {
  ...
  return jsxs(FocusableProvider, Object.assign({}, triggerProps, {
    ...
    children: [/*#__PURE__*/React.cloneElement(triggerElem, { ...mergeProps(triggerElem.props, triggerProps),
      ref: tooltipTriggerRef
...
const TooltipWrapper = /*#__PURE__*/forwardRef(function TooltipWrapper({
  children,
  state,
  ...otherProps
}, ref) {
...
const defaultElement$7 = 'span';
const Badge = /*#__PURE__*/React.memo( /*#__PURE__*/forwardRef(function Badge({
  appearance = 'solid',
  size = 'md',
  as = defaultElement$7,
  className,
  ...
  const stateProps = { ...variants$5[appearance].default,
    ...variants$5[appearance][intent]
  };
  ...
  const isOverflow = ({
    ...
    return ((current === null || current === void 0 ? void 0 : current.offsetWidth) || 0) < (((_a = contentRef === null || contentRef === void 0 ? void 0 : contentRef.current) === null || _a === void 0 ? void 0 : _a.offsetWidth) || 0);
  };

  React.useEffect(() => {
    setOverflowActive(isOverflow(containerRef));
  }, [containerRef]);

  const badge = jsx(Box, Object.assign({
    ref: ref,
    as: as,
    h: sizes$7[size].h,
    px: sizes$7[size].px,
    ...
    rounded: sizes$7[size].rounded,
    borderColor: "on-primary",
    whitespace: "nowrap",
    className: cn$1('sl-badge', className, {
    ...
    children: jsxs(Flex, Object.assign({
      ...
      children: [icon ? jsx(BadgeIcon, {
        ...
        size: size,
        hasContent: !!children
      }, void 0) : null, jsx(Flex, Object.assign({
        flexShrink: true,
        overflowX: "hidden"
      }, {
        children: jsx(Box, Object.assign({
  ...
  return overflowActive ? jsx(Tooltip, Object.assign({
    renderTrigger: badge
  }, {
    children: children
  }), void 0) : badge;
...
const BadgeIcon = ({
  ...
  if (isIconProp(icon)) {
    elem = jsx(Icon, {
      icon: icon,
      style: {
        fontSize: sizes$7[size].iconSize
      },
      pulse: pulse,
      fixedWidth: true
    }, void 0);
  ...
  return jsx(Box, Object.assign({
    "data-testid": "icon",
    mr: hasContent ? sizes$7[size].leftIconMr : undefined,
    mx: hasContent ? undefined : sizes$7[size].leftIconMx
  }, {
    children: elem
  }), void 0);
};
...
const BadgeRightIcon = ({
  ...
  return jsx(Box, Object.assign({
    ...
    ml: sizes$7[size].rightIconMl,
    mr: sizes$7[size].rightIconMr
  }, {
    children: elem
  }), void 0);
};
...
const Callout = /*#__PURE__*/memo(function Callout({
  ...
  return jsx(Box, Object.assign({
    className: cn$1('sl-callout', className),
    rounded: "xl",
    w: "full",
...
const defaultElement$6 = 'span';
const Text = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Text({
  size,
  ...restProps
}, ref) {
  return jsx(Box, Object.assign({
...
const Drawer = ({
  ...
  return /*#__PURE__*/createPortal(jsx(FocusTrap, Object.assign({
    active: isOpen
  }, {
...
const EntityName = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function EntityName(props, ref) {
  ...
  return jsxs(Flex, Object.assign({}, rest, {
    ref: ref,
    align: "center",
    className: cn$1('sl-entity-name', className)
  }, {
...
const defaultElement$5 = 'div';
const FormGroup = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function ButtonGroup({
  children,
  className,
  ...rest
}, ref) {
  return jsx(Flex, Object.assign({
    as: defaultElement$5,
    className: cn$1('sl-form-group', className),
    border: true,
    rounded: true
  }, rest, {
    bg: rest.bg || 'canvas',
...
const Input = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Input({
  ...
  return jsxs(Box, Object.assign({
    className: cn$1('sl-input', 'sl-form-group-border', className),
    pos: "relative"
    ...
    children: [icon ? jsx(InputIcon, {
      ...
      as: "input",
      className: "sl-form-group-border",
      ref: inputRef,
      pl: icon ? 8 : sizes$5[size].px,
      pr: sizes$5[size].px,
...
const Link = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Link({
  className,
  ...restProps
}, ref) {
  const {
  ...
  return jsx(Box, Object.assign({
    ...
    ref: ref,
    className: cn$1('sl-link', className)
  }, restProps), void 0);
}));
...
const LinkHeading = /*#__PURE__*/memo(function LinkHeading({
  ...
  const _className = cn$1('sl-link-heading', className);

  const hash = React.useMemo(() => decodeURIComponent(document.location.hash), []); // Just in case browser doesn't scroll correctly - handle it
  ...
  React.useEffect(() => {
    if (hash === `#${id}`) {
      const timer = setTimeout(() => {
        ...
        (_a = document.querySelector(`[id="${escapeDoubleQuotes(id)}"]`)) === null || _a === void 0 ? void 0 : _a.scrollIntoView({
          behavior: 'smooth',
          block: 'start'
        });
      }, 300);
...
function useOption(props, state, ref) {
  ...
  let {
    pressProps
  } = $f6c31cce2adf654f$export$45712eceda6fad21(_extends({}, itemProps, {
    isDisabled,
...
const ListBox = /*#__PURE__*/React.forwardRef(ListBoxBase);
...
function useMenuItem(props, state, ref) {
  ...
  let {
    pressProps
  } = $f6c31cce2adf654f$export$45712eceda6fad21(mergeProps({
    onPressStart,
    onPressUp,
    onKeyDown,
    isDisabled
...
const Popover = /*#__PURE__*/forwardRef(function Popover(props, ref) {
  ...
  return jsxs(Fragment, {
    children: [triggerElem && jsx($f1ab8c75478c6f73$export$3351871ee4b288b8, Object.assign({}, triggerPropsWithRef, {
      onPress: onPress,
      ...
      children: jsxs(PopoverWrapper, Object.assign({}, overlayProps, {
        style: mergeProps(positionProps.style, {
          zIndex: props.zIndex
        }),
        ref: popoverRef,
        isOpen: state.isOpen,
...
const PopoverWrapper = /*#__PURE__*/forwardRef(function PopoverWrapper({
  children,
  isOpen,
  onClose,
  contain,
...
const isMenuNodeCollection = iterable => {
  return 'getFirstKey' in iterable;
};
...
function $704cf1d3b684cc5c$export$535bd6ca7f90a273$1() {
    let cur = useContext($704cf1d3b684cc5c$var$SSRContext$1);
    let isInSSRContext = cur !== $704cf1d3b684cc5c$var$defaultContext$1;
...
const $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c$2 = typeof window !== 'undefined' ? React__default.useLayoutEffect : ()=>{
};
...
const $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c$1 = typeof window !== 'undefined' ? React__default.useLayoutEffect : ()=>{
};
...
function $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a$1() {
    ...
    let [defaultLocale, setDefaultLocale] = useState($1e5a04cdaf7d1af8$var$currentLocale$1);
    useEffect(()=>{
...
const $18f2051aff69b9bf$var$I18nContext$1 = /*#__PURE__*/ React__default.createContext(null);
function $18f2051aff69b9bf$export$43bb16f9c6d9e3f7$1() {
    let defaultLocale = $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a$1();
    let context = useContext($18f2051aff69b9bf$var$I18nContext$1);
    return context || defaultLocale;
}
...
const $44a6ee657928b002$export$5665e3d6be6adea = /*#__PURE__*/ React__default.forwardRef($44a6ee657928b002$var$ScrollView);
...
function $6d0a5c394373ae64$var$Virtualizer(props, ref) {
    ...
    return(/*#__PURE__*/ React__default.createElement($44a6ee657928b002$export$5665e3d6be6adea, {
        ...$3ef42575df84b30b$export$9d1611c77c2fe928$1(otherProps, virtualizerProps),
        ref: ref,
...
function $6d0a5c394373ae64$export$dd6d526d88b5a137(props, state, ref) {
    ...
    virtualizer.persistedKeys = useMemo(()=>focusedKey ? new Set([
            focusedKey
        ]) : new Set()
    , [
        focusedKey
    ...
    useEffect(()=>{
        if (focusedKey && !focusedView && isFocusWithin.current && document.activeElement !== ref.current) $7215afc6de606d6b$export$de79e2c695e052f3(ref.current);
    });
...
// forwardRef doesn't support generic parameters, so cast the result to the correct type
// https://stackoverflow.com/questions/58469229/react-with-typescript-generics-while-using-react-forwardref
const $6d0a5c394373ae64$export$89be5a243e59c4b2 = /*#__PURE__*/ React__default.forwardRef($6d0a5c394373ae64$var$Virtualizer);
function $6d0a5c394373ae64$var$defaultRenderWrapper(parent, reusableView) {
    return(/*#__PURE__*/ React__default.createElement($ccf8a0a04e4175ae$export$6796df8ba7398521, {
...
const Internal_MenuItemRow = /*#__PURE__*/forwardRef(function MenuItem({
  ...
  const hasRightItems = isExternalLink || meta || meta === 0 || hasSubmenu;
  ...
  const rowChildren = jsxs(Fragment, {
    children: [shouldIndent && jsx(Box, Object.assign({
      ...
      flex: 1,
      w: "full",
      pr: hasRightItems || shouldIndent ? 8 : 0,
      ...
      className: cn$1('sl-menu-item__meta', {
...
function MenuNodes({
  ...
  const modality = useInteractionModality();
  const pointerInteraction = modality === 'pointer';
  let layout = React.useMemo(() => new $61ef60fc9b1041f4$export$cacbb3924155d68e({
    rowHeight: 26,
    padding: 8
  }), []);
  layout.collection = state.collection;
  return isRoot ? jsx($6d0a5c394373ae64$export$89be5a243e59c4b2, Object.assign({
    ref: ref,
    ...
    children: Array.from(items).map((item, i) => jsx(ItemRow, {
      item: item,
      state: state
    }, item.key || i))
  }), void 0);
...
const match = (item, filterString) => {
  return !filterString || !item || !('title' in item) || !item.title || item.title.toLowerCase().includes(filterString);
};

const isChildrenEmpty = children => children.length === 0 || children.every(child => child === null || isMenuDivider(child));

const filterItems = (items, lowercasedFilterString) => {
  return items.map(item => {
    if (!item) return item;

    if ('children' in item && item.children) {
      const children = filterItems(item.children, lowercasedFilterString);

      if (isChildrenEmpty(children)) {
        return null;
      } else {
        return { ...item,
          children: filterItems(item.children, lowercasedFilterString)
        };
      }
    } else {
...
function MenuList({
  ...
  const handleFilterCreate = React.useCallback(() => {
    ...
    onFilterEnterKey === null || onFilterEnterKey === void 0 ? void 0 : onFilterEnterKey(actualValue);
    handleOnClose();
  ...
  return jsx(NoSsr, {
    children: jsx(MenuContext.Provider, Object.assign({
      ...
      children: jsxs(VStack, {
        children: [showFilter ? jsx(Box, Object.assign({
          bg: isDark ? 'canvas-dialog' : 'canvas-pure',
          w: "full",
          style: menuNodesWidthStyles,
          p: size === 'lg' ? 3 : 2,
          ...
          children: jsxs(HStack, {
            children: [jsx(Input, {
              ...
              onKeyUp: handleKeyUp
            }, void 0), onFilterEnterKey && filteredItemsEmpty ? jsx(_Button, {
              icon: "plus",
              title: 'Press "Enter" to create an item not in the list.',
              appearance: "minimal",
        ...
        }), void 0) : null, jsx(MenuNodes, Object.assign({}, props, {
          className: "sl-menu",
...
function Menu({
  ...
  return jsxs(Fragment, {
    children: [jsx($f1ab8c75478c6f73$export$3351871ee4b288b8, Object.assign({
      "aria-label": ariaLabel
    }, menuTriggerProps, {
      ref: ref,
      isPressed: state.isOpen
...
/**
 * This component is primarily used to render change/diff annotations in the UI for elements and JSV components,
 * in the proposals UI.
 */
...
const NodeAnnotation = ({
  ...
  const {
    style = {},
    ...rest
  } = props; // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing

  const selfAffected = change.selfAffected || change.type === 'added' || change.type === 'removed';
  const width = 32; // allow the default offset to be overriden

  const left = Number((_a = style.left) !== null && _a !== void 0 ? _a : -28 - additionalLeftOffset) - width;

  const elem = jsxs(Flex, Object.assign({
    pos: "absolute",
    pinY: "px",
    alignItems: "center",
    style: { ...style,
    ...
    children: [jsx(Box, Object.assign({
      ...
      children: change.isBreaking ? jsx(Box, Object.assign({
        color: "danger"
      }, {
        children: jsx(Icon, {
          icon: [selfAffected ? 'fas' : 'far', 'exclamation-circle']
        }, void 0)
      }), void 0) : null
    }), void 0), jsx(Box, {
      w: 1.5,
  ...
  return jsx(Tooltip, Object.assign({
    ...
    children: jsx(NodeAnnotationTipContents, {
      change: change
    }, void 0)
  }), void 0);
};

const NodeAnnotationTipContents = ({
  change
}) => {
...
const PanelTitlebar = /*#__PURE__*/memo(function PanelTitlebar({
  children,
  icon,
  appearance = 'default',
  rightComponent,
...
const Panel = ({
  ...
  if (! /*#__PURE__*/React.isValidElement(titlebarElement) || /*#__PURE__*/React.isValidElement(titlebarElement) && titlebarElement.type !== PanelTitlebar) {
  ...
  const titlebarComponent = /*#__PURE__*/React.cloneElement(titlebarElement, {
    icon: icon ? jsx(Icon, {
      icon: icon,
      fixedWidth: true,
  ...
  return jsxs(Box, Object.assign({
    w: "full",
    className: cn$1('sl-panel', 'sl-outline-none', className),
...
const Paragraph = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Paragraph({
  size = 'default',
  ...restProps
}, ref) {
  /**
...
const ProgressBar = ({
  ...
  const [progressState, setProgressState] = React.useState(DEFAULT_PROGRESS_BAR_PROPS);
  const [progressTheme, setProgressTheme] = React.useState({
    icon: icon,
    color: color
  });
  const [progressAction, setProgressAction] = React.useState();
  const {
    progressBarProps,
    labelProps
  } = $204d9ebcedfb8806$export$ed5abd763a836edc(progressState); // Calculate the width of the progress bar as a percentage
  ...
  const getProgressTheme = React.useCallback(() => {
    const isApproachingProgressLimit = progressState.value >= approachingProgressLimitValue && progressState.value < progressState.maxValue;
  ...
  }, [approachingProgressLimitColor, approachingProgressLimitIcon, approachingProgressLimitValue, atOrOverProgressLimitColor, atOrOverProgressLimitIcon, color, icon, progressState.maxValue, progressState.value, progressTheme.color, progressTheme.icon]);
  React.useEffect(() => {
    if (value !== null) {
      setProgressState({
        label,
  ...
  return jsx(Box, Object.assign({
    ...
    role: "alert",
    style: {
      borderColor: hasCalloutBorder && sanitizedProgressColor
    }
  }, progressBarProps, {
    children: jsxs(Box, Object.assign({
      ...
      children: [jsxs(Flex, Object.assign({
        ...
        children: [jsx(Flex, {
          children: jsxs(Flex, Object.assign({
            ...
            children: [progressTheme.icon && jsx(Box, Object.assign({
              mr: 4
            }, {
              children: jsx(Icon, {
                size: "lg",
                color: sanitizedProgressColor,
                icon: ['fal', progressTheme.icon]
              }, void 0)
            }), void 0), jsxs(Box, {
              children: [progressState.label && !progressState.isLabelVisuallyHidden && jsx(Box, Object.assign({
                fontSize: "paragraph"
              }, labelProps, {
                lineHeight: "none"
              }, {
                children: label
              }), void 0), progressState.valueLabel && progressState.valueLabel]
            }, void 0)]
          }), void 0)
        }, void 0), progressAction && (typeof progressAction === 'string' ? jsx(_Button, Object.assign({
          style: {
            width: '128px',
            minWidth: '128px',
            marginLeft: '8px'
          ...
          children: progressAction
        }), void 0) : progressAction)]
      }), void 0), hintText && jsx(Box, Object.assign({
        mb: 6,
        fontSize: "paragraph-small"
      }, {
        children: hintText
...
const Prose = /*#__PURE__*/memo(function Prose({
  ...
  return jsx(Box, Object.assign({
    className: cn$1('sl-prose', className)
  }, props), void 0);
});
...
const RadioContext = /*#__PURE__*/React.createContext(undefined);
...
const Radio = /*#__PURE__*/forwardRef(function Radio({
  ...
  const strokeWidth = isSelected ? sizes$3[size].svgStrokeWidth * 2 : sizes$3[size].svgStrokeWidth;
  inputProps.name = name !== null && name !== void 0 ? name : inputProps.name;
  return jsxs(Flex, Object.assign({
    as: "label",
    alignItems: "center",
    className: cn$1('sl-radio-group__radio', {
    ...
    children: [jsx(VisuallyHidden, {
      ...
      children: jsx("svg", Object.assign({
        width: sizes$3[size].svgWidth,
        height: sizes$3[size].svgHeight,
        "aria-hidden": "true",
        style: {
          marginRight: 4
        },
        ...
        children: jsx("circle", {
          cx: sizes$3[size].svgWidth / 2,
          cy: sizes$3[size].svgHeight / 2,
          r: sizes$3[size].svgHeight / 3 - 1,
      ...
      fontSize: sizes$3[size].fontSize,
      fontWeight: 'semibold'
    }, {
      children: children
    }), void 0)]
...
const RadioGroup = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function RadioGroup({
  intent = 'default',
  size = 'md',
  orientation = 'vertical',
  name,
  ...
  return jsxs(Stack, Object.assign({
    ...
    ref: ref,
    className: cn$1('sl-radio-group', className),
    spacing: 2
...
function HiddenSelect(props) {
  ...
  if (state.collection.size <= 300) {
    return /*#__PURE__*/React__default.createElement("div", containerProps, /*#__PURE__*/React__default.createElement("input", inputProps), /*#__PURE__*/React__default.createElement("label", null, label, /*#__PURE__*/React__default.createElement("select", selectProps, /*#__PURE__*/React__default.createElement("option", null), [...state.collection.getKeys()].map(key => {
...
function Select({
  ...
  const triggerElem = jsx(_FieldButton, Object.assign({}, triggerProps, ariaTriggerProps, {
    size: size,
    disabled: isDisabled,
  ...
  const {
    matchedProps: datasetProps
  } = splitDatasetProps(props);
  return jsxs(Box, Object.assign({
    className: cn$1('sl-select', className),
    pos: "relative",
    flexGrow: flexGrow,
    flex: flex,
    w: w
...
const ListBoxPopup = /*#__PURE__*/forwardRef(function ListBoxPopup({
  state,
  minW,
  options,
  ...otherProps
  ...
  const pointerInteraction = $507fabe10e71c6fb$export$630ff653c5ada6a9() === 'pointer';
  return jsxs(Fragment, {
    children: [jsx(DismissButton, {
...
const Switch = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Switch({
  size = 'md',
  showIcon = false,
  className,
  isDisabled,
  ...
  return jsx(Box, Object.assign({
    className: cn$1('sl-switch', className),
    h: sizes$2[size].height,
    w: sizes$2[size].width,
...
function useIsInViewport(ref, options = {}) {
  ...
  const observer = React.useMemo(() => new IntersectionObserver(([entry]) => setIsIntersecting(entry.isIntersecting), options), [options]);
  React.useEffect(() => {
    observer.observe(ref.current);
    return () => {
      observer.disconnect();
...
function TabImpl(props) {
  ...
  const ref = useRef();
  const [scrollToTab] = useScrollTo(ref);
  const {
    isInViewport
  } = useIsInViewport(parentRefs.tablistRef);
  const {
    tabProps
  } = useTab({
    key,
  ...
  const getStateProps = () => {
    if (appearance === 'line' && orientation === 'vertical') {
      return { ...variants$1[appearance][orientation][activeStateAlignment][density].tab
      };
    }

    return { ...variants$1[appearance][orientation][density].tab
    };
  };
  ...
  if (isMinimal) {
    if (orientation === 'vertical' && index === 0) {
      // @ts-expect-error
      stateProps.mt = -1 * stateProps.py + 0.5;
    } else {
      if (index === 0) {
        // @ts-expect-error
        stateProps.ml = -1 * stateProps.px + 0.5;
      }
    }
  }
  /**
...
function TabList({
  ...
  const getStateProps = () => {
    if (appearance === 'line' && orientation === 'vertical') {
      return { ...variants$1[appearance][orientation][activeStateAlignment][density].tabList
      };
    }

    return { ...variants$1[appearance][orientation][density].tabList
    };
  };
...
const Tabs = /*#__PURE__*/React.forwardRef(function Tabs(props, ref) {
  ...
  }, [children, tabListState === null || tabListState === void 0 ? void 0 : tabListState.selectedKey, collapse, tablistRef]);
  let tabPanelProps = {
...
const TagInput = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function TagInput({
  size = 'md',
  className,
  readOnly,
  values: _values,
      ...
      case 'Enter':
        {
          ...
          onChange === null || onChange === void 0 ? void 0 : onChange([...values, value]);
          setValue('');
          break;
        }
  ...
  const disabledProps = readOnly ? {
    tabIndex: -1
  } : {};
  return jsxs(HStack, Object.assign({
    className: "sl-form-group-border",
    border: true,
    borderColor: {
      default: 'input',
    ...
    children: [values.map((value, i) => jsx(Badge, Object.assign({
      ...
      w: "full",
      readOnly: readOnly
    }, disabledProps, inputProps), void 0)]
  }), void 0);
}));
...
const Textarea = /*#__PURE__*/memo( /*#__PURE__*/forwardRef(function Textarea({
  intent = 'default',
  size = 'md',
  resize = 'y',
  appearance = 'default',
  ...
  return jsx(Box, Object.assign({
    className: cn$1('sl-textarea', className),
    pos: "relative"
  }, matchedProps, {
    children: jsx(Box, Object.assign({
      ref: textAreaRef,
...
export { Article, AspectRatio, Avatar, AvatarList, Badge, Box, _Button as Button, ButtonGroup, Callout, Card, Code, Container, _CopyButton as CopyButton, DEFAULT_THEME_MODE, DismissButton, Divider$2 as Divider, Drawer, EntityName, _FieldButton as FieldButton, Flex, FormGroup, GLOBAL_CSS_ID, GLOBAL_CSS_THEME_ID, Grid, HStack, Heading, INIT_THEME_JS, Icon, Image$1 as Image, InitTheme, InlineStyles, Input, InvertTheme, InvertThemeContext, Link, LinkHeading, ListBox, ListBoxItem, Menu, Modal, NoSsr, NodeAnnotation, _Overlay as Overlay, Panel, Paragraph, Popover, $f1ab8c75478c6f73$export$3351871ee4b288b8 as PressResponder, $3b117e43dc0ca95d$export$27c701ed9e449e99 as Pressable, ProductImage, ProgressBar, Prose, MosaicProvider as Provider, Radio, RadioGroup, _Select as Select, Stack, Step, Steps, Switch, THEME_STORAGE_KEY, Tab, TabImpl, TabList, TabPanel, TabPanels, Tabs, TagInput, Text, Textarea, Tooltip, TreeItem, VStack, WithDomRef, __DEV__, accumulateCollectionKeysByProp, appendCss, borderPropNames, borderProps, colorPropNames, colorProps, computeResponsiveClasses, computeTheme, containerSizes, defaultTheme, error, findCss, flexPropNames, flexProps, getContrastColor, getCssVariable, getInteractionModality, getResolvedThemeMode, injectStyles, interactivityPropNames, interactivityProps, isArray, isDefined, isEmpty, isEmptyArray, isEmptyObject, isFunction, isIconDefinition, isIconProp, isInputEvent, isNil, isNotEmptyObject, isNotNumber, isNull, isNumber, isNumeric, isObject, isResponsiveObject, isString, isUndefined, layoutPropNames, layoutProps, marginProps, noop, once, paddingProps, parseHsl, positionPropNames, positionProps, prefersDarkMode, randomColorFromString, readableColor, replaceCss, ringPropNames, ringProps, runIfFn, shadowPropNames, shadowProps, sizePropNames, sizeProps, spacingPropNames, splitBoxProps, splitDatasetProps, splitProps, stringifyHsl, subscribeTheme, transformPropNames, transformProps, typographyPropNames, typographyProps, useBreakpoints, useClipboard, useCollectionKeyAccumulator, useControllableProp, useControllableState, useDrawerState, useIconStore, useId, useInteractionModality, useIsSSR, useModalState, useMosaicContext, useOverlay, useOverlayPosition, useSSRSafeId, useSafeEffect, useTheme, useThemeIsDark, useThemeIsInverted, useThemeMode, useThemeStore, warn };
