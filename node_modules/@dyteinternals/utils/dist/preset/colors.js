 ...
 */
export const generateShades = (baseHexCode, reducer = BRAND_SHADE_REDUCER, weight = 0.4) => {
    const shades = [];
    const [red, green, blue] = hexToRGB(baseHexCode);
...
export const getBrandColors = (shade) => {
...
export const getBackgroundColors = (shade) => {
    if (shade === '#FFFFFF') {
        return THEMES.light.background;
    }
    else if (shade === '#000000') {
        return THEMES.dark.background;
    }
