...
export class RemoteSdp {
    ...
    send({ offerMediaObject, reuseMid, offerRtpParameters, answerRtpParameters, codecOptions, extmapAllowMixed = false, forceGoogConference = false, }) {
    ...
    muxMediaSectionSimulcast(mid, encodings) {
        ...
        const mediaSection = this._mediaSections[idx];
        if (mediaSection === undefined) {
            throw new Error(`no media section found with idx '${idx}'`);
        }
