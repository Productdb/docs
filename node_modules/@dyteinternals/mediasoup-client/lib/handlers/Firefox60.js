...
export class Firefox60 extends HandlerInterface {
     ...
     */
    static createFactory(supportsSendEncoding = false) {
        return () => new Firefox60(supportsSendEncoding);
    }
    constructor(supportsSendEncoding = false) {
        super();
        ...
        this.supportsSendEncoding = false;
        this.supportsSendEncoding = supportsSendEncoding;
    }
    get name() {
        return 'Firefox60';
    }
    ...
    async send({ track, encodings, codecOptions, codec }) {
        ...
        const additionalParams = this.supportsSendEncoding && encodings !== undefined ? {
        ...
        if (!this.supportsSendEncoding && encodings) {
