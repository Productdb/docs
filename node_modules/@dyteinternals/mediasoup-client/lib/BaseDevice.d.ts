...
export type BuiltinHandlerName = 'Chrome111' | 'Chrome74' | 'Chrome70' | 'Firefox60' | 'Firefox111' | 'Safari12' | 'Edge11' | 'ReactNativeUnifiedPlan' | 'ReactNative';
...
export declare abstract class BaseDevice {
    protected _handlerFactory: HandlerFactory;
    ...
    abstract switchDevice(handlerName: string): void;
    /**
