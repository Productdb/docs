...
export function detectDevice() {
    ...
    // Browser.
        ...
        // Fix for Motorola Edge being detected as Microsoft Edge
        // TODO: replace bower
        ua = ua === null || ua === void 0 ? void 0 : ua.replace('motorola edge', 'motorola x');
        ...
        // Firefox.
        else if (browser.satisfies({ firefox: '>=111' })) {
            return 'Firefox111';
        }
        // Firefox.
        ...
        // Ios in-app Browsers
        else if (((_b = (_a = browser.parsedResult) === null || _a === void 0 ? void 0 : _a.os) === null || _b === void 0 ? void 0 : _b.name) === 'iOS' &&
            typeof RTCRtpTransceiver !== 'undefined' &&
            RTCRtpTransceiver.prototype.hasOwnProperty('currentDirection')) {
            return 'Safari12';
        }
        ...
        else if (((_d = (_c = browser.parsedResult) === null || _c === void 0 ? void 0 : _c.os) === null || _d === void 0 ? void 0 : _d.name) === 'iOS' &&
            typeof RTCRtpTransceiver !== 'undefined' &&
            RTCRtpTransceiver.prototype.hasOwnProperty('currentDirection')) {
            return 'Safari12';
        }
        // MacOS In-App Browsers (using WkWebview)
        else if (engine.name && engine.name.toLowerCase() === 'webkit' &&
            engine.version && parseFloat(engine.version) > 605) {
            return 'Safari12';
        }
        // Unsupported browser.
        else {
