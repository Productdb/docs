import { AwaitQueue } from '@dyteinternals/awaitqueue';
...
export class Transport extends EnhancedEventEmitter {
    ...
    /**
     * NOTE(callmetarush): Exposing all active producers to not
     * duplicate the same type of producers
     */
    get producers() {
    ...
    async produceData({ ordered = true, maxPacketLifeTime, maxRetransmits, label = '', protocol = '', appData = {} } = {}) {
        ...
        return this._awaitQueue.push(async () => {
            ...
            const dataProducer = new DataProducer({ id, dataChannel, sctpStreamParameters, appData });
