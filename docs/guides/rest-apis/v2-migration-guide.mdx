...
1. Log into the [Developer Portal](https://dev.productdb.io/).
...
1. In the [Developer Portal](https://dev.productdb.io/), select **Presets**.
...
[Postman collection](https://www.postman.com/productdb-api/workspace/productdb-s-public-workspace/collection/208979[…]8d7-8739-49ac-b88c-c5e6ec365e21?action=share&creator=20897959)
...
| **Base URL** | **v1**                   | **v2**                   |
| ------------ | ------------------------ | ------------------------ |
|              | `https://api.productdb.io/v1` | `https://api.productdb.io/v2` |
...
<head>
  ...
  <meta
    name="description"
    content="Explore the migration guide for transitioning to ProductDB's V2. Follow our guide for effective migration strategies and implementation."
  />
</head>
