...
This topic covers essential concepts related to ProductDB's interactive live streaming (ILS). For the concepts related to live video applications, see [Video Conferencing concepts](/guides/live-video/concepts).
