...
<head>
  ...
  <meta name="description" content="Explore the setup of the client for live video in JavaScript with Dyte's features. Follow our guide for effective JavaScript client setup."/>
</head>
