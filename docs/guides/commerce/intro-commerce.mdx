...
ProductDB's voice conferencing platform, built upon [WebRTC](https://productdb.io/blog/webrtc/), enables you to seamlessly incorporate real-time communication features into your web and mobile applications. Using ProductDB's REST APIs and client-side SDKs, you can effortlessly acquire, transmit, and play media within your applications.
...
<head>
  ...
  <meta
    name="description"
    content="Get started with ProductDB's Voice Conference capabilities. Follow our guide for an introduction to voice conferencing and its features."
  />
</head>
