...
```bash
curl --location --request POST 'https://api.productdb.io/v2/livestreams' \
...
```bash
curl --location \
     --request GET 'https://api.productdb.io/v2/livestreams/9fb22eea-3392-42ad-b884-1129a4f517d2' \
     --header 'Authorization: Basic ZGVtbzpwQDU1dzByZA=='
```
...
<head>
  ...
  <meta name="description" content="Learn how to livestream to any RTMP server with ProductDB. Follow our guide for effective RTMP livestreaming and integration."/>
</head>
