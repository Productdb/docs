...
:::info Beta
The new Chat SDK is currently in beta and may not be available for your organization by default. If you would like to use this feature, please [contact us](https://productdb.io/contact) and we can enable it for you.

Chat SDK is still in the testing phase and may undergo some changes. If you encounter any issues or have suggestions for improvements to the feature, please [connect](https://productdb.io/contact) with us.
:::
...
<head>
  ...
  <meta
    name="description"
    content="Get started with ProductDB's realtime chat capabilities. Follow our guide for an introduction to realtime chat and its features."
  />
</head>
