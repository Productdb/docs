...
For this, we have provided a sample in NodeJS for you to checkout (ProductDB-io/google-transcription)[https://github.com/ProductDB-io/google-transcription/tree/main/server]. Please find it here. Currently, we only have NodeJS samples; if you're working on a different backend, feel free to port this code.

To use this sample, please clone the repository using the following command.

```
git clone git@github.com:ProductDB-io/google-transcription.git
```
...
```
npm install @ProductDBsdk/google-transcription
```

Source available at (ProductDB-io/google-transcription)(https://github.com/ProductDB-io/google-transcription/tree/main/client)
...
```
import ProductDBGoogleSpeechRecognition from '@ProductDBsdk/google-transcription';
```

Add the following code just after the point where you have access to the meeting object.

```ts
const speech = new ProductDBGoogleSpeechRecognition({
    meeting, // ProductDB meeting object from ProductDBClient.init
...
If you need a sample of this guide, please refer to https://github.com/ProductDB-io/google-transcription/blob/main/client/demo/index.ts
