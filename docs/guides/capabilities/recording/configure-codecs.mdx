...
<head>
  <title>Configure Video Settings Guide</title>
  <meta name="description" content="Learn how to configure codecs for recording in ProductDB's capabilities. Follow our guide for effective codec configuration."/>
</head>
