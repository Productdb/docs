...
2. ProductDB generates a downloadable link from which the recording can be
   ...
   or from the [Developer Portal](https://dev.productdb.io/).
...
3. Download the recording from the download url and store it to your cloud
   ...
   from the [Developer Portal](https://dev.productdb.io/).
   ...
   the [Developer Portal](https://dev.productdb.io/) or the
...
<head>
  ...
  <meta name="description" content="Learn about the overview of recording capabilities with ProductDB. Follow our guide for an in-depth understanding of recording features."/>
</head>
