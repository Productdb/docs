...
`storage-config' using the [Developer Portal](https://dev.productdb.io/).
...
<head>
  ...
  <meta
    name="description"
    content="Explore how to start recordings with ProductDB's recording capabilities. Follow our guide for effective recording initiation."
  />
</head>
