...
- [Organization level](https://dev.productdb.io/recordings) specified via developer portal
...
| 3          | [Organization level](https://dev.productdb.io/recordings) specified via developer portal | Lowest priority in the system. Settings defined here will be overridden by both Start recording a meeting API config and Create a meeting API config. |
...
<head>
  ...
  <meta name="description" content="Learn how to manage recording configuration hierarchy with ProductDB's capabilities. Follow our guide for effective hierarchy management."/>
</head>
