...
:::info Note
Your stream key is generated when [creating a livestream](/guides/rest-apis/livestream-ProductDB-meeting#step-2-create-a-live-stream).
:::
...
<head>
  <title>Restream to Social Platforms Guide</title>
  <meta name="description" content="Learn how to livestream on other platforms with ProductDB's capabilities. Follow our guide for effective livestreaming integration."/>
</head>
