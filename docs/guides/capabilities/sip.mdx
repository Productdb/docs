...
Now to connect to a specific ProductDB `meetingId`, you can dial in using SIP with the given username and password and an URI in the format `sip:<meetingId>@sip.dyte.io`
