...
```json
{
  ...
  "recording": {
    ...
    "downloadUrl": "https://ProductDB-recordings-test.s3.ap-south-1.amazonaws.com/c94c437b-592a-4a39-b9e2-47ef1451e43b/test.mp4",
    ...
    "audioDownloadUrl": "https://ProductDB-recordings-test.s3.ap-south-1.amazonaws.com/c94c437b-592a-4a39-b9e2-47ef1451e43b/test.mp3",
...
<head>
  ...
  <meta name="description" content="Explore various webhook events and their implementation with ProductDB's capabilities. Follow our guide for effective event handling."/>
</head>
