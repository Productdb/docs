...
:::info beta
The meeting transcription feature is currently in beta, which means it is still being tested and evaluated, and may undergo some change. This feature is not accessible to the public at the moment and will be activated solely upon request, subject to our team's assessment of your usage and needs. If you wish to have this feature enabled for your organization, please [get in touch with us](https://productdb.io/contact).
:::
...
You can create a new preset on our [Developer Portal](https://dev.productdb.io/presets), or using our [REST API](/api#/operations/post-presets).
...
You can do this either on our [Developer Portal](https://dev.productdb.io/webhooks), or using a [REST API](/api#/operations/addWebhook).
...
<head>
  ...
  <meta name="description" content="Explore meeting transcription capabilities with ProductDB's AI. Follow our guide to understand and implement transcription features."/>
</head>
