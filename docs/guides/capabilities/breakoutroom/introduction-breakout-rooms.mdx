...
:::info Beta
The breakout rooms feature is currently in beta, which means it is still being tested and evaluated, and may undergo some change. Please [contact us](https://productdb.io/contact) if you encounter any issues or have suggestions for improvements to the feature.
:::
...
<head>
  <title>Introduction to ProductDB's Breakout Rooms Guide</title>
  <meta name="description" content="Get an introduction to breakout rooms with ProductDB's capabilities. Follow our guide for a smooth understanding and integration."/>
</head>
