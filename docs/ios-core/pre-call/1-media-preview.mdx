...
If you are using our UI Kits, this functionality can be handled by `ProductDBSetupViewController` or built with `ProductDBParticipantTileView`
and `ProductDBSettingViewController` components.
