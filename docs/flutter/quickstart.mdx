...
[Getting Started with ProductDB](https://docs.productdb.io/getting-started) topic and
completed the steps in the
[Integrate ProductDB](https://docs.productdb.io/getting-started#integrate-productdb) section.
You must complete the following steps:

- Create a [ProductDB Developer Account](https://dev.productdb.io/)
- Create [Presets](https://dev.productdb.io/roles-presets)
- Create a
  [ProductDB Meeting](https://docs.productdb.io/api/?v=v2#/operations/create_meeting)
- [Add Participant](https://docs.productdb.io/api/?v=v2#/operations/add_participant)
  to the meeting
...
To initiate ProductDB Meeting for any participant you just need to pass `authToken` as an argument. You can get the `authToken` via the [Add Participant API](https://docs.productdb.io/api?v=v2#/operations/add_participant).
