...
- `ProductDBMobileClient`: (**Required**) An instance of `ProductDBMobileClient` used to perform actions like leaving the meeting room or ending the meeting for all participants.
