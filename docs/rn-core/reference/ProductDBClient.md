...
The ProductDBClient class is the main class of this library.
An object of the ProductDBClient class can be created using
`await initMeeting({ ... })`. Typically, an object of `ProductDBClient` is
named `meeting`.
...
### initMeeting(options)
The `initMeeting` method can be used to instantiate the ProductDBClient class.
