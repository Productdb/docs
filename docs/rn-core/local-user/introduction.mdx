  ...
  <TabItem value="ios">
    ...
    - Add these changes to your iOS folder's Podfile:
      ...
      target 'YOUR_APP_TARGET_NAME'
        ...
        post_install do |installer|
          ...
          # Add these for ProductDB iOS Screenshare
      ...
      pod 'YOUR_BROADCAST_EXTENSION_TARGET_NAME'
          ...
          pod 'ReactNativeCore', :path => '../node_modules/@ProductDBsdk/react-native-core'
      end
      ```
    - Replace the <code>SampleHandler</code> in Broadcast Upload Extension with the following:
      ```swift
        ...
        class SampleHandler: ProductDBScreenshareHandler {
          override init() {
    ...
    - Now enable the screenshare pop up handle and then enable ProductDB's screenshare API:
      ```tsx
      // Import this component
      import { NativeModules, findNodeHandle } from 'react-native';
      import { ScreenCapturePickerView } from '@ProductDBinternals/react-native-webrtc';
