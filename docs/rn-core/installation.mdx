...
```shell
npm install @ProductDBsdk/react-native-core @ProductDBinternals/react-native-webrtc
```
...
```shell
yarn add @ProductDBsdk/react-native-core @ProductDBinternals/react-native-webrtc
```

  </TabItem>
</Tabs>

[![npm version](https://badge.fury.io/js/@ProductDBsdk%2Freact-native-core.svg)](https://badge.fury.io/js/@ProductDBsdk%2Freact-native-core)
