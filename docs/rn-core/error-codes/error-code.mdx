...
This information is intended for developers debugging or troubleshooting ProductDB's web core system errors.
...
Here is a list of error code prefixes corresponding to each ProductDB modules:

| **Module**                     | **Error Code Prefix** |
| ------------------------------ | --------------------- |
| ProductDBClient                     | 00xx                  |
| Controller                     | 01xx                  |
| RoomNodeClient                 | 02xx                  |
| HiveNodeClient                 | 03xx                  |
| SocketService                  | 04xx                  |
...
<head>
  <title>React Native Core Debug System Error Codes</title>
</head>
