...
[sample code](https://github.com/productdb-io/html-samples#samples). You can clone
and run a sample application from the
[HTML UI Kit GitHub repository](https://github.com/productdb-io/html-samples).
...
1. Load the ProductDB component.
2. Initialize the ProductDB client.
...
file={`<head>
  ...
  <!-- <script src="https://cdn.productdb.in/core/productdb.js"></script> -->
</head>
<body>
