---
description: >-
  Learn how to use and customize the productdb-notifications component in ProductDB's UI
...
```html
<productdb-notifications id="productdb-el"></productdb-notifications>
...
<head>
  <title>UI Kit productdb-notifications</title>
</head>
