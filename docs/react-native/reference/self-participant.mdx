...
# ProductDBSelfParticipant

Being a subclass of [`ProductDBParticipant`](./participant), all the properties and
methods of `ProductDBParticipant` are available to `ProductDBSelfParticipant`. Other than
