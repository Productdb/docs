...
With components like **DyteGridView** and **DyteParticipantTileView**, ProductDB's UI Kit simplifies video rendering 
in meetings and offers the flexibility to create dynamic video calling experiences.

### Complete Code

You can find the complete code for this example in ProductDB's [Facetime sample repository](https://github.com/dyte-io/android-samples/tree/main/samples/facetime). 
