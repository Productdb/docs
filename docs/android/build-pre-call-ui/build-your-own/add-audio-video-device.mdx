...
To let the user choose between multiple available input / output devices, you can use the `ProductDBSettingsFragment` or `ProductDBSettingsBottomsheet` component
...
val videoAdapter = ArrayAdapter(
        requireContext(),
        R.layout.ProductDB_spinner_item,
