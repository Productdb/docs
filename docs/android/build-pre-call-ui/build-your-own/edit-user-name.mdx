...
We add a `<ProductDBInputField>` element for entering the participant name. We should not show this input if the user doese not have permission to edit name (`meeting.localUser.permissions.miscellaneous.canEditDisplayName`)
