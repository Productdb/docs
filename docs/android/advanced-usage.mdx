...
```kotlin
val meeting = ProductDBUIKit.meeting
```
...
```kotlin
val designTokens = ProductDBUIKit.designTokens
```
...
<head>
  ...
  <meta name="description" content="Explore advanced usage scenarios and features in ProductDB for Android with our detailed documentation."/>
</head>
