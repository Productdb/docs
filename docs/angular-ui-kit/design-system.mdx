...
https://productdb.io/blog/new-productdb-video-sdk-design-system/

## `provideProductDBDesignSystem()` utility
...
<script>
  provideProductDBDesignSystem(document.getElementById('app'), {
    googleFont: 'Lobster',
...
<head>
  <title>Angular UI Kit Design System</title>
  <meta name="description" content="Explore the design system and guidelines for using ProductDB's Angular UI Kit in your applications."/>
</head>
