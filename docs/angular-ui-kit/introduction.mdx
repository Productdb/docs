...
- **Use prebuilt component**: You can use prebuilt `ProductDB-meeting` component to
...
<head>
  ...
  <meta
    name="description"
    content="Discover the UI components available in ProductDB's Angular UI Kit with our comprehensive documentation."
  />
</head>
