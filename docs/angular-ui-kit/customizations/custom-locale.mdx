...
```jsx
import { defaultLanguage, useLanguage } from '@ProductDBsdk/angular-ui-kit';
```
...
<head>
  ...
  <meta name="description" content="Learn how to customize the locale settings in ProductDB's Angular UI Kit with our comprehensive documentation."/>
</head>
