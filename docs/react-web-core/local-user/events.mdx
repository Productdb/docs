...
```ts
const videoEnabled = useProductDBSelector((meeting) => meeting.self.videoEnabled);
const videoTrack = useProductDBSelector((meeting) => meeting.self.videoTrack);
...
```ts
const audioEnabled = useProductDBSelector((meeting) => meeting.self.audioEnabled);
const audioTrack = useProductDBSelector((meeting) => meeting.self.audioTrack);
...
```ts
const screenShareEnabled = useProductDBSelector(
  (meeting) => meeting.self.screenShareEnabled
);
const screenShareTrack = useProductDBSelector(
