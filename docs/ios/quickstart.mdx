...
[iOS UI Kit Sample App GitHub repository](https://github.com/ProductDB-io/ios-samples/tree/main/).
...
<CocoaPodInstallation pkg="ProductDBUiKit" path="9/b/8/ProductDBUiKit" />
...
- ### **Swift Package Manager**
  Add `ProductDBUiKit` SDK through Swift Package Manager in Xcode. Use https://github.com/ProductDB-in/ios-uikit-framework.git as the package source.
...
To set the initialization properties in the `ProductDBUiKit` class, simply initialize `ProductDBMeetingInfoV2` mention in the step 2
...
```swift
      ...
      let ProductDBUikit = ProductDBUiKit(meetingInfoV2: meetingInfo)

```

## Step 4: Launch the meeting UI

Follow the step 2 and step 3 to initialize MeetingObject using `ProductDBUIKit` class. Use the startMeeting method on ProductDBUIKit object you get in step 3 to launch UI

Try this in `viewDidAppear()`

```swift
import ProductDBUiKit
import ProductDBiOSCore
...
class ViewController: UIViewController {
    ...
    var ProductDBUikit: ProductDBUiKit!
   ...
   override func viewDidAppear(_ animated: Bool) {
        ...
        let meetingInfo = ProductDBMeetingInfoV2(authToken: "<authToken>",
                                     ...
                                     enableVideo: true, 
                                     baseUrl: "productdb.io")
        ProductDBUikit = ProductDBUiKit(meetingInfoV2: meetingInfo)
        let controller = ProductDBUikit.startMeeting {
            [weak self] in
...
<head>
  ...
  <meta
    name="description"
    content="Quickstart your iOS app integration with ProductDB Docs. Follow step-by-step guides for a smooth and efficient setup."
  />
</head>
