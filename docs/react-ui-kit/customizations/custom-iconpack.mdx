...
2. Initialize the ProductDB client using the `useDyteClient()` hook. It returns an array with two values, the meeting object and a function to initialize the meeting.
