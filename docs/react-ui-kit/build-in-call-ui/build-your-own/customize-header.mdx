...
file={`
import { defaultConfig, generateConfig, ProductDBLogo, ProductDBRecordingIndicator, ProductDBLivestreamIndicator, ProductDBMeetingTitle, ProductDBGridPagination, ProductDBParticipantCount, ProductDBViewerCount, ProductDBClock } from '@dytesdk/react-ui-kit';
