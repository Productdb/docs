...
Each plugin in the list is of type `ProductDBPlugin` which has the following public fields and methods:

```kotlin
class ProductDBPlugin {
    val id: String
    val name: String
...
<head>
  <title>Android Core Plugins Introduction</title>
</head>
