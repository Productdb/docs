...
final isCameraPermissionGranted
  = ProductDBMobileClient.localUser.permissions.isCameraPermissionGranted;
final isMicrophonePermissionGranted
  = ProductDBMobileClient.localUser.permissions.isMicrophonePermissionGranted;
```
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to manage permissions in your Flutter application for a secure and controlled user experience with ProductDB Docs."
  />
</head>
