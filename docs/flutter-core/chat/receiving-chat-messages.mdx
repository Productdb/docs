...
```dart
ProductDBClient.addChatEventsListener(ChatEventsListener());
```
...
Whenever a chat message is received, the `ProductDBClient.chat.messages` list is automatically updated.
