...
- `dyteMobileClient.localUser.audioEnabled`: A <span className="tag-orange">boolean</span> value indicating if the audio currently enabled.
- `dyteMobileClient.localUser.videoEnabled`: A <span className="tag-orange">boolean</span> value indicating if the video currently enabled.
