...
[`ProductDBClient.polls`](./introduction) object. The `ProductDBClient.polls.create()`
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to create and vote on polls in Flutter using ProductDB's features. Follow our documentation for seamless integration and effective poll creation."
  />
</head>
