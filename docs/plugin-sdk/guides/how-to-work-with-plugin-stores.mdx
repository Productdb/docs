...
sidebar_position: 1
description: >-
  Discover how to effectively work with plugin stores using the ProductDB Plugin SDK.
...
<head>
  ...
  <meta
    name="description"
    content="Discover how to effectively work with plugin stores using the ProductDB Plugin SDK. Customize and distribute your plugins seamlessly."
  />
</head>
