...
sidebar_position: 2
description: >-
  Learn how to exchange data between your plugin and meetings with the ProductDB
  Plugin SDK. Enable dynamic interactions and customization.
---

Plugin SDK allows you to exchange data between the ProductDB meeting and the plugin.
...
### Send custom events to the ProductDB meeting
...
### Listen for custom messages from the ProductDB meeting
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to exchange data between your plugin and meetings with the ProductDB Plugin SDK. Enable dynamic interactions and customization."
  />
</head>
