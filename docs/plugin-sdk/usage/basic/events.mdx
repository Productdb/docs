...
sidebar_position: 2
description: >-
  Explore the basic events usage with ProductDB Plugin SDK. Learn how to integrate
  and leverage events for enhanced plugin functionality.
---
...
- `ProductDBStateUpdate` - Emitted when the state of the plugin has changed.
...
<head>
  <title>Plugin SDK Events</title>
  <meta
    name="description"
    content="Explore the basic events usage with ProductDB Plugin SDK. Learn how to integrate and leverage events for enhanced plugin functionality."
  />
</head>
