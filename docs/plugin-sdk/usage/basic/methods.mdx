...
sidebar_position: 1
description: >-
  Learn the basic methods of using ProductDB Plugin SDK for efficient integration.
...
<head>
  ...
  <meta
    name="description"
    content="Learn the basic methods of using ProductDB Plugin SDK for efficient integration. Enhance your app's functionality with powerful plugin methods."
  />
</head>
