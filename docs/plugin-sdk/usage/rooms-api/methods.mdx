...
sidebar_position: 1
description: >-
  Explore the usage of Rooms API methods with ProductDB Plugin SDK. Optimize your
  app's functionality by integrating powerful room management methods.
---
...
<head>
  ...
  <meta
    name="description"
    content="Explore the usage of Rooms API methods with ProductDB Plugin SDK. Optimize your app's functionality by integrating powerful room management methods."
  />
</head>
