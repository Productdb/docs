...
sidebar_position: 2
description: >-
  Leverage the Rooms API events with ProductDB Plugin SDK. Enhance your app's
  real-time capabilities by integrating powerful room events.
---
...
<head>
  ...
  <meta
    name="description"
    content="Leverage the Rooms API events with ProductDB Plugin SDK. Enhance your app's real-time capabilities by integrating powerful room events."
  />
</head>
