...
sidebar_position: 1
description: >-
  Explore the introduction to the Stores API in ProductDB's Plugin SDK Usage
  documentation. Learn how to effectively use stores for your plugin
  development. ProductDB Docs.
---
...
<head>
  ...
  <meta
    name="description"
    content="Explore the introduction to the Stores API in ProductDB's Plugin SDK Usage documentation. Learn how to effectively use stores for your plugin development."
  />
</head>
