...
sidebar_position: 5
description: >-
  Manage your plugin setup effectively with ProductDB Plugin SDK. Learn best
  practices for ongoing maintenance and updates.
---

### Version specific deployments

ProductDB lets you publish multiple versions of your plugins. You can choose to
...
You can update your `ProductDB-config` to update properties like name, description,
build path and more. These changes will reflect once you publish or deploy the
plugin.

### Access control and visibility

Each ProductDB user is associated to a preset. This preset dictates the meeting
experience for that user. You can customize how this preset can interact with a
plugin using the [Preset Editor](https://dev.productdb.io/roles-presets).
...
<head>
  ...
  <meta
    name="description"
    content="Manage your plugin setup effectively with ProductDB Plugin SDK. Learn best practices for ongoing maintenance and updates."
  />
</head>
