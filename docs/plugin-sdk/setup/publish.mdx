...
sidebar_position: 3
description: >-
  Guide on how to publish your plugin setup using the ProductDB Plugin SDK. Ensure a
...
2. Copy `productdb-config.json` into the folder which contains `index.html`. If
...
Read more about how you can manage plugins with ProductDB CLI
...
<head>
  ...
  <meta
    name="description"
    content="Guide on how to publish your plugin setup using the ProductDB Plugin SDK. Ensure a seamless deployment and distribution process for your plugins."
  />
</head>
