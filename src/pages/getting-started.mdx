---
description: A short guide on how to integrate ProductDB and how ProductDB works with your
  application
---

# Introduction to ProductDB

ProductDB offers solutions for integrating high-quality video/voice calls into your
...
ProductDB currently supports the following platforms:
...
## Components of ProductDB

- **Backend HTTP REST APIs**: Your backend uses ProductDB REST APIs to perform
  actions such as, create meetings, add participants to a meeting etc.
- **Frontend SDKs**: Your applications bundle ProductDB Core SDKs (and UI Kits) to
  ...
  - **UI Kit**: By utilizing ProductDB's prebuilt design library of UI components, you can seamlessly integrate video and voice calls into your app or website within minutes.
...
# Getting Started With ProductDB

This topic gives a quick
walkthrough of the steps involved in integrating high-quality real-time
communication features into your app using ProductDB.

## Integrate ProductDB

1. To get started with ProductDB, you must first register in the
   [Developer portal](https://dev.productdb.io)

2. Copy the [API Keys](https://dev.productdb.io/apikeys) for your organization from
   the Developer portal. These API Keys are unique to your organization and are
   required to use ProductDB REST APIs such as when instantiating a meeting

![APIKeys](/static/home/api-keys.png)

3. [Create presets](https://dev.productdb.io/roles-presets) using the Developer
...
4. Create a ProductDB meeting using the
...
![Diagram explaining how ProductDB works](/static/home/how-ProductDB-works-v2.png)
_Diagram explaining how ProductDB works_
...
ProductDB meetings do not have a date or time associated with them, so you can create
...
A communication channel created on ProductDB is termed as a `meeting`.
...
- You can set the maximum number of people on screen, the maximum number of
  ...
  plugins, and so on. ProductDB also includes the following four prebuilt presets.
